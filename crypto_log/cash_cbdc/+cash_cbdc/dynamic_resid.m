...
residual(7) = lhs - rhs;
lhs = y(14)*(y(14)-1);
rhs = 1/params(17)*(1+y(13)*params(13)-params(13))+y(53)*y(81)/y(20)*y(77)*(y(77)-1);
residual(8) = lhs - rhs;
lhs = y(20);
rhs = T(13)*T(14);
residual(9) = lhs - rhs;
...
rhs = y(51)/(y(51)+y(50));
residual(20) = lhs - rhs;
lhs = y(54)*params(39)*T(18)*T(19)-params(41)*2*y(51)*(params(40)-y(55))/T(20);
rhs = y(56)-params(6)*y(83)/y(77);
residual(21) = lhs - rhs;
lhs = y(54)*params(38)*T(18)*T(21)-params(41)*2*(params(40)-y(55))*T(22);
rhs = y(56)-params(6)*y(83)*params(37)/y(77);
residual(22) = lhs - rhs;
residual(23) = y(49);
lhs = y(56)*y(16);
...
residual(24) = lhs - rhs;
lhs = 1;
rhs = y(53)*(y(78)+params(12)*y(80))/T(23);
residual(25) = lhs - rhs;
lhs = 1;
rhs = y(53)*y(17)/y(77);
residual(26) = lhs - rhs;
lhs = y(19);
rhs = 1+y(41)+T(29)*params(15)*y(24)/(steady_state(12));
residual(27) = lhs - rhs;
lhs = y(36);
rhs = T(1)*T(25);
residual(28) = lhs - rhs;
lhs = y(58);
rhs = T(1)*(T(24)-y(52)/y(77));
residual(29) = lhs - rhs;
lhs = y(37);
rhs = T(1)*(T(24)-y(39)*y(79)/y(18));
residual(30) = lhs - rhs;
lhs = y(35);
rhs = T(1)*y(17)/y(77);
residual(31) = lhs - rhs;
...
residual(33) = lhs - rhs;
lhs = y(32);
rhs = y(37)/(params(5)*y(35))-1/params(1)+T(28);
residual(34) = lhs - rhs;
lhs = y(20);
rhs = y(44)+y(43)+y(26)+y(23)+y(24)*(1+y(41))+T(27);
residual(35) = lhs - rhs;
lhs = y(31);
...
residual(47) = lhs - rhs;
lhs = y(45);
rhs = y(20)-y(18)*y(21)-T(27)-y(43)-y(44);
residual(48) = lhs - rhs;
lhs = y(61);
rhs = log(y(20));
residual(49) = lhs - rhs;
