...
M_.mapping.Pi.eqidx = [8 21 22 26 28 29 30 31 35 37 43 44 48 50 60 ];
...
M_.mapping.Q.eqidx = [5 25 27 28 37 38 39 40 60 ];
...
M_.mapping.K_b.eqidx = [5 37 38 39 40 42 ];
...
M_.state_var = [5 6 13 16 18 19 26 27 28 34 36 45 ];
...
oo_.steady_state(22) = 3.998415966096;
...
options_.order = 1;
var_list_ = {'logY';'logPi';'logR';'R';'logI';'logL';'logC';'logEX';'logM';'logD';'logD_star';'logN';'spread';'logDC';'logm';'leverage';'TB';'R_dc'};
...
save([M_.dname filesep 'Output' filesep 'cash_cbdc_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'cash_cbdc_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'cash_cbdc_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'cash_cbdc_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'cash_cbdc_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'cash_cbdc_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'cash_cbdc_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
