...
opt.objname={'WELF';'TPE'};                     %objectives of players
opt.instname{1,1}={'PHI_HEAD','PHI_COMM',...
                    'PHI_CORE','PHI_Y'};        %instruments of player 1
opt.instname{2,1}={'MRKss','Q_COMM','Q_Y'};                %instruments of player 2
opt.grid{1,1}(1,1)={[0:0.1:2.5]};                 %grid for instrument 1 player 1
opt.grid{1,1}(1,2)={[0:0.2:2]};                 %grid for instrument 2 player 1 
opt.grid{1,1}(1,3)={[0:0.1:2.5]}; 
