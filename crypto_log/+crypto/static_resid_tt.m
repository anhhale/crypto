...
T(17) = y(6)^params(16);
T(18) = params(35)^(0.5*y(43)+0.5*y(44));
T(19) = y(7)+params(9)*y(17)/y(13);
T(20) = (y(3)+y(7)*params(12))/y(7)-y(5)/y(2);
T(21) = sqrt((y(25)/(params(5)*y(23)))^2+(1/params(1))^2+2*y(24)/(params(5)*y(23)));
T(22) = params(17)/2*(y(2)-1)^2;
T(23) = y(8)*T(22);
