...
residual(24) = lhs - rhs;
lhs = 1;
rhs = y(41)*(y(3)+y(7)*params(12))/T(22);
residual(25) = lhs - rhs;
lhs = 1;
rhs = y(41)*y(5)/y(2);
residual(26) = lhs - rhs;
...
residual(31) = lhs - rhs;
lhs = y(22);
rhs = y(23)/(y(30)+y(23)*T(4)*T(5)-(y(24)+y(20)*y(25)));
residual(32) = lhs - rhs;
lhs = y(21);
rhs = y(30)*y(22);
residual(33) = lhs - rhs;
lhs = y(20);
rhs = y(25)/(params(5)*y(23))-1/params(1)+T(25);
residual(34) = lhs - rhs;
lhs = y(8);
rhs = y(32)+y(31)+y(14)+y(11)+y(12)*(1+y(29))+T(27);
residual(35) = lhs - rhs;
lhs = y(19);
...
residual(37) = lhs - rhs;
lhs = y(7)*y(16)*(1+T(4)*T(5));
rhs = y(15)*y(22)*(1+T(4)*T(5));
residual(38) = lhs - rhs;
lhs = y(7)*y(16)*(1+T(4)*T(5));
...
residual(47) = lhs - rhs;
lhs = y(33);
rhs = y(8)-y(6)*y(9)-T(27)-y(31)-y(32);
residual(48) = lhs - rhs;
lhs = y(49);
rhs = log(y(8));
residual(49) = lhs - rhs;
