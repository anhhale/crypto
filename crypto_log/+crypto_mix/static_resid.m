...
if T_flag
    T = crypto_mix.static_resid_tt(T, y, x, params);
end
residual = zeros(47, 1);
lhs = y(46)+y(44);
rhs = 1/T(2);
...
residual(5) = lhs - rhs;
lhs = y(30);
rhs = params(2)*exp(y(20)*(-params(1)));
residual(6) = lhs - rhs;
lhs = y(1);
rhs = T(10)*T(11);
residual(7) = lhs - rhs;
...
residual(17) = lhs - rhs;
lhs = y(47);
rhs = y(47)*0.95+0.03*x(5);
residual(18) = lhs - rhs;
lhs = y(11);
rhs = T(19)^(1/(1-params(29)));
residual(19) = lhs - rhs;
lhs = y(45);
rhs = y(39)/(y(39)+y(38));
residual(20) = lhs - rhs;
lhs = y(44)*params(39)*T(20)*T(21)-params(41)*2*y(39)*(params(40)-y(45))/T(22);
rhs = y(46)-params(6)*y(46)/y(2);
residual(21) = lhs - rhs;
lhs = y(44)*params(38)*T(20)*T(23)-params(41)*2*(params(40)-y(45))*T(24);
rhs = y(46)-params(6)*y(46)*params(37)/y(2);
residual(22) = lhs - rhs;
lhs = params(34)*(y(34)*y(37))^(-params(31));
rhs = y(46)-y(40)*params(6)*y(46)/y(2);
residual(23) = lhs - rhs;
lhs = y(4);
rhs = params(8)*y(10)^params(7);
residual(24) = lhs - rhs;
lhs = 1;
rhs = y(41)*(y(3)+y(7)*params(12))/T(25);
residual(25) = lhs - rhs;
lhs = 1;
rhs = y(41)*y(5)/y(2);
residual(26) = lhs - rhs;
...
residual(32) = lhs - rhs;
lhs = y(20);
rhs = y(25)/(params(5)*y(23))-1/params(1)+T(27);
residual(33) = lhs - rhs;
lhs = y(8);
rhs = y(32)+y(31)+y(14)+y(11)+y(12)*(1+y(29))+T(29);
residual(34) = lhs - rhs;
lhs = y(19);
...
residual(46) = lhs - rhs;
lhs = y(33);
rhs = y(8)-y(6)*y(9)-T(29)-y(31)-y(32);
residual(47) = lhs - rhs;
if ~isreal(residual)
