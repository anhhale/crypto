...
if T_flag
    T = crypto_bank_mix.static_resid_tt(T, y, x, params);
end
residual = zeros(48, 1);
lhs = y(44)+y(42);
rhs = 1/T(2);
...
rhs = y(39)/(y(39)+y(38));
residual(20) = lhs - rhs;
lhs = y(42)*params(39)*T(21)*T(22)-params(41)*2*y(39)*(params(40)-y(43))/T(23);
rhs = y(44)-params(6)*y(44)/y(2);
residual(21) = lhs - rhs;
lhs = y(42)*params(38)*T(21)*T(24)-params(41)*2*(params(40)-y(43))*T(25);
rhs = y(44)-params(6)*y(44)*params(37)/y(2);
residual(22) = lhs - rhs;
lhs = params(34)*y(37)^(-params(31));
rhs = y(44)-y(40)*params(6)*y(44)/y(2);
residual(23) = lhs - rhs;
lhs = y(4);
rhs = params(8)*y(10)^params(7);
residual(24) = lhs - rhs;
lhs = 1;
rhs = y(41)*(y(3)+y(7)*params(12))/T(26);
residual(25) = lhs - rhs;
lhs = 1;
rhs = y(41)*y(5)/y(2);
residual(26) = lhs - rhs;
...
residual(31) = lhs - rhs;
lhs = y(22);
rhs = y(23)/(y(30)+y(23)*T(5)*T(6)-(y(24)+y(20)*y(25)+y(46)*y(47)));
residual(32) = lhs - rhs;
lhs = y(21);
rhs = y(30)*y(22);
residual(33) = lhs - rhs;
...
residual(36) = lhs - rhs;
lhs = y(15);
rhs = params(3)*(y(16)*(y(3)+y(7)*params(12))-y(5)*y(18)/y(2)-y(40)*y(37)/y(2)-y(19)*y(27)*y(6))+y(13)*(y(3)+y(7)*params(12))*params(4);
residual(37) = lhs - rhs;
lhs = y(7)*y(16)*(1+T(5)*T(6));
rhs = y(15)*y(22)*(1+T(5)*T(6));
residual(38) = lhs - rhs;
lhs = y(7)*y(16)*(1+T(5)*T(6));
rhs = y(37)+y(15)+y(18)+y(6)*y(19);
residual(39) = lhs - rhs;
lhs = y(20);
