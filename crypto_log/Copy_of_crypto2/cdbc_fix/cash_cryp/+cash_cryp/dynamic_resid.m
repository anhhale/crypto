...
residual(1) = lhs - rhs;
lhs = y(55);
rhs = params(6)*y(87)/y(58);
residual(2) = lhs - rhs;
lhs = y(80);
rhs = y(55)*(1-params(3)+params(3)*y(86));
residual(3) = lhs - rhs;
lhs = y(43);
...
residual(8) = lhs - rhs;
lhs = y(16)*(y(16)-1);
rhs = 1/params(17)*(1+y(15)*params(13)-params(13))+y(55)*y(85)/y(22)*y(81)*(y(81)-1);
residual(9) = lhs - rhs;
lhs = y(22);
rhs = T(13)*T(14);
residual(10) = lhs - rhs;
...
residual(21) = lhs - rhs;
residual(22) = y(52);
residual(23) = params(6)*y(87)*params(37)/y(81)+y(56)-y(58);
lhs = 0;
rhs = y(58)-y(54)*params(6)*y(87)/y(81);
residual(24) = lhs - rhs;
lhs = y(18);
rhs = params(8)*y(24)^params(7);
residual(25) = lhs - rhs;
lhs = 1;
rhs = y(55)*(y(82)+params(12)*y(84))/T(17);
residual(26) = lhs - rhs;
lhs = 1;
rhs = y(55)*y(19)/y(81);
residual(27) = lhs - rhs;
...
residual(29) = lhs - rhs;
lhs = y(60);
rhs = y(80)*(T(18)-y(54)/y(81));
residual(30) = lhs - rhs;
lhs = y(39);
rhs = y(80)*(T(18)-y(41)*y(83)/y(20));
residual(31) = lhs - rhs;
lhs = y(37);
rhs = y(80)*y(19)/y(81);
residual(32) = lhs - rhs;
