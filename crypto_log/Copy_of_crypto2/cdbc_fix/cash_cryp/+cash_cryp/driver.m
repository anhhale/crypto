...
M_.endo_names(61) = {'logm'};
M_.endo_names_tex(61) = {'logm'};
M_.endo_names_long(61) = {'logm'};
M_.endo_names(62) = {'leverage'};
M_.endo_names_tex(62) = {'leverage'};
M_.endo_names_long(62) = {'leverage'};
M_.endo_names(63) = {'TB'};
M_.endo_names_tex(63) = {'TB'};
M_.endo_names_long(63) = {'TB'};
M_.endo_names(64) = {'logcryp'};
M_.endo_names_tex(64) = {'logcryp'};
M_.endo_names_long(64) = {'logcryp'};
M_.endo_names(65) = {'spread2'};
M_.endo_names_tex(65) = {'spread2'};
M_.endo_names_long(65) = {'spread2'};
M_.endo_names(66) = {'Omega'};
M_.endo_names_tex(66) = {'Omega'};
M_.endo_names_long(66) = {'Omega'};
...
M_.mapping.Pi.eqidx = [9 23 24 27 29 30 31 32 36 38 44 45 49 51 61 ];
...
M_.mapping.phi.eqidx = [33 34 39 63 ];
M_.mapping.upsilon.eqidx = [32 33 35 ];
M_.mapping.mu.eqidx = [29 33 35 66 ];
...
M_.mapping.cryp.eqidx = [38 40 42 65 ];
M_.mapping.DC.eqidx = [22 ];
M_.mapping.m.eqidx = [20 62 ];
M_.mapping.R_c.eqidx = [18 24 30 38 ];
M_.mapping.Lambda.eqidx = [2 3 9 26 27 ];
M_.mapping.gam.eqidx = [1 23 ];
M_.mapping.trs.eqidx = [21 ];
M_.mapping.Lambda1.eqidx = [1 2 23 24 ];
...
oo_.steady_state(22) = 3.990000872677;
...
oo_.steady_state(37) = oo_.steady_state(44)-M_.params(6)*oo_.steady_state(44)*oo_.steady_state(40)/oo_.steady_state(2);
...
oo_.steady_state(41) = M_.params(6);
oo_.steady_state(66) = oo_.steady_state(41)*(1-M_.params(3)+M_.params(3)*oo_.steady_state(21));
oo_.steady_state(65) = log(oo_.steady_state(24));
...
oo_.steady_state(61) = log(oo_.steady_state(39));
oo_.steady_state(62) = log(oo_.steady_state(22));
oo_.steady_state(63) = log(oo_.steady_state(14)-oo_.steady_state(9));
oo_.steady_state(64) = log(oo_.steady_state(37));
if M_.exo_nbr > 0
