...
hold on
plot(z,flex_oo_irfs.logPi_varepsilon_A *400,'b-+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.logPi_varepsilon_A *400,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.logPi_varepsilon_A *400,'m-^','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
hold on
plot(z,flex_oo_irfs.logR_varepsilon_A *400,'b-+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.logR_varepsilon_A *400,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.logR_varepsilon_A *400,'m-^','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
subplot(4,4,10) 
plot(z,fix_oo_irfs.spread2_varepsilon_A *100,'Color','black','LineWidth',1,'MarkerSize',3)
hold on
plot(z,flex_oo_irfs.spread2_varepsilon_A *100,'b-+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.spread2_varepsilon_A *100,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.spread2_varepsilon_A *100,'m-^','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
subplot(4,4,11) 
plot(z,fix_oo_irfs.logRDC_varepsilon_A *400,'Color','black','LineWidth',1,'MarkerSize',3)
hold on
plot(z,flex_oo_irfs.logRDC_varepsilon_A *400,'b-+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.logRDC_varepsilon_A *400,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.logRDC_varepsilon_A *400,'m-^','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
%{
subplot(4,4,14) 
plot(z,fix_oo_irfs.logRDC_varepsilon_A *100,'--','LineWidth',1,'MarkerSize',3)
hold on
plot(z,flex_oo_irfs.logRDC_varepsilon_A *100,'bb--+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.logRDC_varepsilon_A *100,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.logRDC_varepsilon_A *100,'k-*','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); %hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
hold on
plot(z,flex_oo_irfs.logPi_varepsilon_R *400,'b-+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.logPi_varepsilon_R *400,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.logPi_varepsilon_R *400,'m-^','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
hold on
plot(z,flex_oo_irfs.logR_varepsilon_R *400,'b-+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.logR_varepsilon_R *400,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.logR_varepsilon_R *400,'m-^','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
subplot(4,4,10) 
plot(z,fix_oo_irfs.spread2_varepsilon_R *100,'Color','black','LineWidth',1,'MarkerSize',3)
hold on
plot(z,flex_oo_irfs.spread2_varepsilon_R *100,'b-+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.spread2_varepsilon_R *100,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.spread2_varepsilon_R *100,'m-^','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
subplot(4,4,11) 
plot(z,fix_oo_irfs.logRDC_varepsilon_R *400,'Color','black','LineWidth',1,'MarkerSize',3)
hold on
plot(z,flex_oo_irfs.logRDC_varepsilon_R *400,'b-+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.logRDC_varepsilon_R *400,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.logRDC_varepsilon_R *400,'m-^','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
%{
subplot(4,4,14) 
plot(z,fix_oo_irfs.logRDC_varepsilon_R *100,'--','LineWidth',1,'MarkerSize',3)
hold on
plot(z,flex_oo_irfs.logRDC_varepsilon_R *100,'bb--+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.logRDC_varepsilon_R *100,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.logRDC_varepsilon_R *100,'k-*','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); %hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
hold on
plot(z,flex_oo_irfs.logPi_varepsilon_Rstar *400,'b-+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.logPi_varepsilon_Rstar *400,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.logPi_varepsilon_Rstar *400,'m-^','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
hold on
plot(z,flex_oo_irfs.logR_varepsilon_Rstar *400,'b-+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.logR_varepsilon_Rstar *400,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.logR_varepsilon_Rstar *400,'m-^','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
subplot(4,4,10) 
plot(z,fix_oo_irfs.spread2_varepsilon_Rstar *100,'Color','black','LineWidth',1,'MarkerSize',3)
hold on
plot(z,flex_oo_irfs.spread2_varepsilon_Rstar *100,'b-+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.spread2_varepsilon_Rstar *100,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.spread2_varepsilon_Rstar *100,'m-^','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
subplot(4,4,11) 
plot(z,fix_oo_irfs.logRDC_varepsilon_Rstar *400,'Color','black','LineWidth',1,'MarkerSize',3)
hold on
plot(z,flex_oo_irfs.logRDC_varepsilon_Rstar *400,'b-+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.logRDC_varepsilon_Rstar *400,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.logRDC_varepsilon_Rstar *400,'m-^','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); hline.Color='[0 1 0]';hline.LineWidth=1.5;
...
%{
subplot(4,4,14) 
plot(z,fix_oo_irfs.logRDC_varepsilon_Rstar *100,'--','LineWidth',1,'MarkerSize',3)
hold on
plot(z,flex_oo_irfs.logRDC_varepsilon_Rstar *100,'bb--+','LineWidth',1,'MarkerSize',3)
hold on
plot(z,markdown_oo_irfs.logRDC_varepsilon_Rstar *100,'r-o','LineWidth',1,'MarkerSize',3)
hold on
plot(z,quantity_oo_irfs.logRDC_varepsilon_Rstar *100,'k-*','LineWidth',1,'MarkerSize',3)
hold off
grid on
xlim([1 lengthH]); axis tight; grid minor
hline = refline(0, 0); %hline.Color='[0 1 0]';hline.LineWidth=1.5;
