...
T(18) = y(6)^params(16);
T(19) = params(35)^y(36);
T(20) = y(11)^params(29)*params(38);
T(21) = y(42)*T(20);
T(22) = y(39)^(-params(29));
T(23) = y(7)+params(9)*y(17)/y(13);
T(24) = y(5)/y(2);
T(25) = (y(3)+y(7)*params(12))/y(7)-T(24);
T(26) = sqrt((y(25)/(params(5)*y(23)))^2+(1/params(1))^2+2*y(24)/(params(5)*y(23)));
T(27) = params(17)/2*(y(2)-1)^2;
T(28) = y(8)*T(27);
