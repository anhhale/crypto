...
T(2) = y(56)*(1-params(3)+params(3)*y(86));
...
T(16) = y(21)^params(16);
T(17) = params(35)^y(51);
T(18) = params(38)*y(54)^(1-params(29))+params(41)*y(53)^(1-params(29));
T(19) = y(26)^params(29);
T(20) = y(53)^(-params(29));
T(21) = (y(54)+y(53))^2;
T(22) = y(54)^(-params(29));
T(23) = y(58)/(y(54)+y(53))-1/(y(54)+y(53));
T(24) = y(22)+params(9)*y(32)/y(28);
T(25) = y(20)/y(81);
T(26) = (y(82)+params(12)*y(84))/y(22)-T(25);
T(27) = sqrt((y(40)/(params(5)*y(38)))^2+(1/params(1))^2+y(62)*2*y(61)/(params(5)*y(38))+2*y(39)/(params(5)*y(38)));
