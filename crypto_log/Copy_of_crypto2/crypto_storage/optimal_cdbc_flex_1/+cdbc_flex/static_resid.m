...
residual(15) = lhs - rhs;
lhs = log(y(35));
rhs = log(y(35))*0.07999999999999996+0.92*(params(39)*log(y(2))+params(40)*log(y(8)/(y(8))));
residual(16) = lhs - rhs;
lhs = y(40);
rhs = 1;
residual(17) = lhs - rhs;
...
rhs = y(39)/(y(39)+y(38));
residual(20) = lhs - rhs;
lhs = y(42)*params(41)*T(21)*T(22)-params(43)*2*y(39)*(params(42)-y(43))/T(23);
rhs = y(44)-y(35)*params(6)*y(44)/y(2);
residual(21) = lhs - rhs;
lhs = y(42)*params(38)*T(21)*T(24)-params(43)*2*(params(42)-y(43))*T(25);
