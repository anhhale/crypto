...
Theta = theta_0;%theta_0*exp(-theta*x)
...
chi_h = 0.014279647772;

chi_b = 0.011032429200;
...
stoch_simul(order=1,irf=80)Ynet C I EX M D D_star epsilon Q N Pi R  ; //Ynet C I EX M D_star epsilon Q N Pi R R_star ;
