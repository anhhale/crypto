...
rhs = y(58)-y(49)*params(6)*y(87)/y(81);
residual(21) = lhs - rhs;
lhs = y(56)*params(38)*T(19)*T(22)-params(41)*2*(params(40)-y(57))*T(23);
rhs = y(58)-params(6)*y(87)*params(37)/y(81);
residual(22) = lhs - rhs;
...
residual(24) = lhs - rhs;
lhs = 1;
rhs = y(55)*(y(82)+params(12)*y(84))/T(24);
residual(25) = lhs - rhs;
lhs = 1;
rhs = y(55)*y(19)/y(81);
residual(26) = lhs - rhs;
...
residual(28) = lhs - rhs;
lhs = y(60);
rhs = T(2)*(T(25)-y(54)/y(81));
residual(29) = lhs - rhs;
lhs = y(39);
rhs = T(2)*(T(25)-y(41)*y(83)/y(20));
residual(30) = lhs - rhs;
lhs = y(37);
rhs = T(2)*y(19)/y(81);
residual(31) = lhs - rhs;
