...
DC=0;
Lambda1= 1/(C-zeta_0*L^(1+zeta)/(1+zeta));
%m=((Lambda1-betta*Lambda1*ep_m)/mu_m)^(1/(-rho_m));
...
stoch_simul(order=1,irf=20, nograph) logY logPi logR logD_star ;
cash_cryp_oo_irfs=oo_.irfs;
save cash_cryp_oo_irfs cash_cryp_oo_irfs     