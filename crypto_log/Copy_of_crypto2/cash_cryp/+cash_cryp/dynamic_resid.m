...
residual(1) = lhs - rhs;
lhs = y(55);
rhs = params(6)*y(85)/y(56);
residual(2) = lhs - rhs;
lhs = y(78);
rhs = y(55)*(1-params(3)+params(3)*y(84));
residual(3) = lhs - rhs;
lhs = y(43);
...
residual(19) = lhs - rhs;
residual(20) = y(52);
lhs = params(33)*y(53)^(-params(30));
rhs = y(56)-params(6)*y(85)*params(37)/y(79);
residual(21) = lhs - rhs;
lhs = params(34)*y(51)^(-params(31));
rhs = y(56)-y(54)*params(6)*y(85)/y(79);
residual(22) = lhs - rhs;
lhs = y(18);
...
residual(27) = lhs - rhs;
lhs = y(58);
rhs = y(78)*(T(18)-y(54)/y(79));
residual(28) = lhs - rhs;
lhs = y(39);
rhs = y(78)*(T(18)-y(41)*y(81)/y(20));
residual(29) = lhs - rhs;
lhs = y(37);
rhs = y(78)*y(19)/y(79);
residual(30) = lhs - rhs;
lhs = y(36);
rhs = y(37)/(y(44)+y(37)*T(3)*T(4)-(y(38)+y(34)*y(39)+y(58)*y(59)));
residual(31) = lhs - rhs;
lhs = y(35);
rhs = y(44)*y(36);
residual(32) = lhs - rhs;
...
rhs = x(it_, 1)+(1-params(19))*(log(y(16))*params(20)+0.*log(y(22)/(steady_state(8)))+log(y(60))*0.3)+params(19)*log(params(6)*y(1));
residual(43) = lhs - rhs;
lhs = log(y(40));
