...
residual(30) = lhs - rhs;
lhs = y(22);
rhs = y(23)/(y(30)+y(23)*T(4)*T(5)-(y(24)+y(20)*y(25)+y(44)*y(45)));
residual(31) = lhs - rhs;
lhs = y(21);
rhs = y(30)*y(22);
residual(32) = lhs - rhs;
lhs = y(20);
rhs = y(25)/(params(5)*y(23))-1/params(1)+T(22);
residual(33) = lhs - rhs;
lhs = y(8);
rhs = y(32)+y(31)+y(14)+y(11)+y(12)*(1+y(29))+T(24);
residual(34) = lhs - rhs;
lhs = y(19);
...
rhs = x(1)+(1-params(19))*(log(y(2))*params(20)+0.*log(y(8)/(y(8)))+log(y(46))*0.3)+log(params(6)*y(5))*params(19);
residual(43) = lhs - rhs;
lhs = log(y(26));
...
residual(47) = lhs - rhs;
lhs = y(33);
rhs = y(8)-y(6)*y(9)-T(24)-y(31)-y(32);
residual(48) = lhs - rhs;
lhs = y(47);
rhs = log(y(8));
residual(49) = lhs - rhs;
