...
M_.endo_names(43) = {'sigma_Rc'};
M_.endo_names_tex(43) = {'sigma\_Rc'};
M_.endo_names_long(43) = {'sigma_Rc'};
M_.endo_names(44) = {'mu_cryp'};
M_.endo_names_tex(44) = {'mu\_cryp'};
M_.endo_names_long(44) = {'mu_cryp'};
M_.endo_names(45) = {'x_c'};
M_.endo_names_tex(45) = {'x\_c'};
M_.endo_names_long(45) = {'x_c'};
M_.endo_names(46) = {'DE'};
M_.endo_names_tex(46) = {'DE'};
M_.endo_names_long(46) = {'DE'};
M_.endo_names(47) = {'logY'};
M_.endo_names_tex(47) = {'logY'};
M_.endo_names_long(47) = {'logY'};
M_.endo_names(48) = {'logPi'};
M_.endo_names_tex(48) = {'logPi'};
M_.endo_names_long(48) = {'logPi'};
M_.endo_names(49) = {'logR'};
M_.endo_names_tex(49) = {'logR'};
M_.endo_names_long(49) = {'logR'};
M_.endo_names(50) = {'logI'};
M_.endo_names_tex(50) = {'logI'};
M_.endo_names_long(50) = {'logI'};
M_.endo_names(51) = {'logL'};
M_.endo_names_tex(51) = {'logL'};
M_.endo_names_long(51) = {'logL'};
M_.endo_names(52) = {'logC'};
M_.endo_names_tex(52) = {'logC'};
M_.endo_names_long(52) = {'logC'};
M_.endo_names(53) = {'logEX'};
M_.endo_names_tex(53) = {'logEX'};
M_.endo_names_long(53) = {'logEX'};
M_.endo_names(54) = {'logM'};
M_.endo_names_tex(54) = {'logM'};
M_.endo_names_long(54) = {'logM'};
M_.endo_names(55) = {'logD'};
M_.endo_names_tex(55) = {'logD'};
M_.endo_names_long(55) = {'logD'};
M_.endo_names(56) = {'logD_star'};
M_.endo_names_tex(56) = {'logD\_star'};
M_.endo_names_long(56) = {'logD_star'};
M_.endo_names(57) = {'logN'};
M_.endo_names_tex(57) = {'logN'};
M_.endo_names_long(57) = {'logN'};
M_.endo_names(58) = {'spread'};
M_.endo_names_tex(58) = {'spread'};
M_.endo_names_long(58) = {'spread'};
M_.endo_names(59) = {'logm'};
M_.endo_names_tex(59) = {'logm'};
M_.endo_names_long(59) = {'logm'};
M_.endo_names(60) = {'leverage'};
M_.endo_names_tex(60) = {'leverage'};
M_.endo_names_long(60) = {'leverage'};
M_.endo_names(61) = {'TB'};
M_.endo_names_tex(61) = {'TB'};
M_.endo_names_long(61) = {'TB'};
M_.endo_names(62) = {'logcryp'};
M_.endo_names_tex(62) = {'logcryp'};
M_.endo_names_long(62) = {'logcryp'};
M_.endo_names(63) = {'spread2'};
M_.endo_names_tex(63) = {'spread2'};
M_.endo_names_long(63) = {'spread2'};
M_.endo_names(64) = {'Omega'};
M_.endo_names_tex(64) = {'Omega'};
M_.endo_names_long(64) = {'Omega'};
...
M_.equations_tags = {
  ...
  18 , 'name' , 'R_c' ;
  19 , 'name' , 'sigma_Rc' ;
  20 , 'name' , 'FOC wrt cbdc' ;
  21 , 'name' , 'FOC wrt money' ;
  22 , 'name' , 'FOC wrt crypto' ;
  23 , 'name' , 'FOC wrt labour, eq. (9)' ;
  24 , 'name' , 'FOC wrt savings in equity, eq. (10)' ;
  25 , 'name' , 'FOC wrt savings in deposits, eq. (11)' ;
  26 , 'name' , 'FOC wrt investment goods, eq. (12)' ;
  27 , 'name' , 'excess return on capital over home deposits, eq. (17)' ;
  28 , 'name' , 'cost advantage of crypto currency debt over home deposits, eq. (18)' ;
  29 , 'name' , 'cost advantage of foreign currency debt over home deposits, eq. (18)' ;
  30 , 'name' , 'marginal cost of deposit, eq. (19)' ;
  31 , 'name' , 'bank leverage multiple, eq. (20)' ;
  32 , 'name' , 'Tobin Q ratio of the bank, eq. (21)' ;
  33 , 'name' , 'fraction of assets financed by foreign borrowing, eq. (22)' ;
  34 , 'name' , 'output, eq. (23)' ;
  35 , 'name' , 'law of motion of net foreign debt, eq. (24)' ;
  36 , 'name' , 'aggregate net worth of banks, eq. (25)' ;
  37 , 'name' , 'aggregate balance sheet of the bank, eq. (26)' ;
  38 , 'name' , 'aggregate balance sheet of the bank, eq. (27)' ;
  39 , 'name' , 'aggregate balance sheet of the bank, eq. (28)' ;
  40 , 'name' , 'aggregate balance sheet of the bank, eq. (28)' ;
  41 , 'name' , 'aggregate capital, eq. (29)' ;
  42 , 'name' , '42' ;
  43 , 'name' , 'Taylor rule, eq. (30)' ;
  44 , 'name' , 'productivity' ;
  45 , 'name' , 'foreign income' ;
  46 , 'name' , 'foreign interest rate' ;
  47 , 'name' , 'spread2' ;
...
M_.mapping.Pi.eqidx = [9 21 22 25 27 28 29 30 34 36 42 43 48 50 60 ];
M_.mapping.Z.eqidx = [8 11 12 24 27 36 60 ];
M_.mapping.w.eqidx = [8 12 23 ];
M_.mapping.R.eqidx = [25 27 28 29 30 36 43 51 60 ];
M_.mapping.epsilon.eqidx = [8 11 14 29 35 36 38 39 42 48 ];
M_.mapping.Q.eqidx = [6 24 26 27 36 37 38 39 40 60 ];
M_.mapping.Y.eqidx = [9 10 34 43 48 49 ];
M_.mapping.M.eqidx = [10 11 35 48 56 63 ];
M_.mapping.L.eqidx = [1 10 12 23 53 ];
M_.mapping.C.eqidx = [1 34 54 ];
M_.mapping.I.eqidx = [4 13 26 34 52 ];
M_.mapping.K.eqidx = [5 10 11 12 13 24 36 41 ];
M_.mapping.EX.eqidx = [14 34 35 55 63 ];
M_.mapping.N.eqidx = [36 37 38 59 ];
M_.mapping.K_b.eqidx = [6 36 37 38 39 40 41 ];
M_.mapping.K_h.eqidx = [5 24 41 ];
M_.mapping.D.eqidx = [36 38 57 ];
M_.mapping.D_star.eqidx = [35 36 38 39 58 ];
M_.mapping.x.eqidx = [6 31 33 37 38 39 ];
M_.mapping.psi.eqidx = [3 32 ];
M_.mapping.phi.eqidx = [31 32 37 62 ];
M_.mapping.upsilon.eqidx = [30 31 33 ];
M_.mapping.mu.eqidx = [27 31 33 47 ];
M_.mapping.mu_star.eqidx = [29 31 33 ];
M_.mapping.A.eqidx = [8 10 44 ];
M_.mapping.R_star.eqidx = [29 35 36 46 ];
M_.mapping.Y_star.eqidx = [14 45 ];
M_.mapping.Phi.eqidx = [4 26 34 ];
M_.mapping.Theta.eqidx = [7 31 32 ];
M_.mapping.chi_h.eqidx = [5 34 48 ];
M_.mapping.chi_b.eqidx = [6 34 48 ];
M_.mapping.Ynet.eqidx = [48 ];
M_.mapping.P_c.eqidx = [15 18 ];
M_.mapping.R_dc.eqidx = [17 ];
M_.mapping.theta_c.eqidx = [15 16 ];
M_.mapping.cryp.eqidx = [22 36 38 40 64 ];
M_.mapping.DC.eqidx = [20 ];
M_.mapping.m.eqidx = [21 61 ];
M_.mapping.R_c.eqidx = [18 22 28 36 ];
M_.mapping.Lambda.eqidx = [2 3 9 24 25 ];
M_.mapping.Lambda1.eqidx = [1 2 21 22 ];
M_.mapping.sigma_Rc.eqidx = [19 ];
M_.mapping.mu_cryp.eqidx = [28 31 33 ];
M_.mapping.x_c.eqidx = [31 33 40 ];
M_.mapping.DE.eqidx = [42 43 ];
...
M_.mapping.spread2.eqidx = [47 ];
M_.mapping.Omega.eqidx = [3 27 28 29 30 ];
M_.mapping.varepsilon_R.eqidx = [43 ];
M_.mapping.varepsilon_A.eqidx = [44 ];
M_.mapping.varepsilon_Rstar.eqidx = [46 ];
M_.mapping.varepsilon_Ystar.eqidx = [45 ];
M_.mapping.eps_Rc.eqidx = [19 ];
M_.mapping.vol.eqidx = [16 ];
M_.static_and_dynamic_models_differ = false;
M_.has_external_function = false;
M_.state_var = [5 6 13 16 18 19 26 27 28 34 36 37 40 43 ];
...
oo_.steady_state(32) = 0.020999067808;
oo_.steady_state(29) = 0.000000000000;
oo_.steady_state(37) = 0.917984614619;
oo_.steady_state(39) = 1.390815144576;
...
oo_.steady_state(45) = oo_.steady_state(37)/oo_.steady_state(16);
...
oo_.steady_state(41) = M_.params(6);
oo_.steady_state(64) = oo_.steady_state(41)*(1-M_.params(3)+M_.params(3)*oo_.steady_state(21));
oo_.steady_state(63) = log(oo_.steady_state(24));
oo_.steady_state(43) = 0;
oo_.steady_state(47) = log(oo_.steady_state(8));
oo_.steady_state(48) = log(oo_.steady_state(2));
oo_.steady_state(49) = log(oo_.steady_state(5));
oo_.steady_state(50) = log(oo_.steady_state(12));
oo_.steady_state(51) = log(oo_.steady_state(10));
oo_.steady_state(52) = log(oo_.steady_state(11));
oo_.steady_state(53) = log(oo_.steady_state(14));
oo_.steady_state(54) = log(oo_.steady_state(9));
oo_.steady_state(55) = log(oo_.steady_state(18));
oo_.steady_state(56) = log(oo_.steady_state(19));
oo_.steady_state(57) = log(oo_.steady_state(15));
oo_.steady_state(58) = log((oo_.steady_state(3)+M_.params(12)*oo_.steady_state(7))/oo_.steady_state(7)-oo_.steady_state(5)/oo_.steady_state(2));
oo_.steady_state(59) = log(oo_.steady_state(39));
oo_.steady_state(60) = log(oo_.steady_state(22));
oo_.steady_state(61) = log(oo_.steady_state(14)-oo_.steady_state(9));
oo_.steady_state(62) = log(oo_.steady_state(37));
if M_.exo_nbr > 0
...
options_.order = 1;
var_list_ = {'logY';'logPi';'logR';'logD_star'};
