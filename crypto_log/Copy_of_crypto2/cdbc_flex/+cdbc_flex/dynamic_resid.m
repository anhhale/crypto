...
residual(1) = lhs - rhs;
lhs = y(56);
rhs = params(6)*y(90)/y(59);
residual(2) = lhs - rhs;
lhs = y(83);
rhs = y(56)*(1-params(3)+params(3)*y(89));
residual(3) = lhs - rhs;
lhs = y(44);
...
residual(8) = lhs - rhs;
lhs = y(17)*(y(17)-1);
rhs = 1/params(17)*(1+y(16)*params(13)-params(13))+y(56)*y(88)/y(23)*y(84)*(y(84)-1);
residual(9) = lhs - rhs;
lhs = y(23);
rhs = T(13)*T(14);
residual(10) = lhs - rhs;
...
rhs = y(54)/(y(54)+y(53));
residual(21) = lhs - rhs;
lhs = y(57)*params(39)*T(18)*T(19)-params(41)*2*y(54)*(params(40)-y(58))/T(20);
rhs = y(59)-y(50)*params(6)*y(90)/y(84);
residual(22) = lhs - rhs;
lhs = y(57)*params(38)*T(18)*T(21)-params(41)*2*(params(40)-y(58))*T(22);
rhs = y(59)-params(6)*y(90)*params(37)/y(84);
residual(23) = lhs - rhs;
lhs = params(34)*y(52)^(-params(31));
rhs = y(59)-y(55)*params(6)*y(90)/y(84);
residual(24) = lhs - rhs;
lhs = y(19);
rhs = params(8)*y(25)^params(7);
residual(25) = lhs - rhs;
lhs = 1;
rhs = y(56)*(y(85)+params(12)*y(87))/T(23);
residual(26) = lhs - rhs;
lhs = 1;
rhs = y(56)*y(20)/y(84);
residual(27) = lhs - rhs;
lhs = y(22);
rhs = 1+y(44)+T(29)*params(15)*y(27)/(steady_state(12));
residual(28) = lhs - rhs;
lhs = y(39);
rhs = y(83)*T(25);
residual(29) = lhs - rhs;
lhs = y(61);
rhs = y(83)*(T(24)-y(55)/y(84));
residual(30) = lhs - rhs;
lhs = y(40);
rhs = y(83)*(T(24)-y(42)*y(86)/y(21));
residual(31) = lhs - rhs;
lhs = y(38);
rhs = y(83)*y(20)/y(84);
residual(32) = lhs - rhs;
lhs = y(37);
rhs = y(38)/(y(45)+y(38)*T(3)*T(4)-(y(39)+y(35)*y(40)+y(61)*y(62)));
residual(33) = lhs - rhs;
lhs = y(36);
rhs = y(45)*y(37);
residual(34) = lhs - rhs;
lhs = y(35);
rhs = y(40)/(params(5)*y(38))-1/params(1)+T(26);
residual(35) = lhs - rhs;
lhs = y(23);
rhs = y(47)+y(46)+y(29)+y(26)+y(27)*(1+y(44))+T(28);
residual(36) = lhs - rhs;
lhs = y(34);
...
residual(38) = lhs - rhs;
lhs = y(22)*y(31)*(1+T(3)*T(4));
rhs = y(30)*y(37)*(1+T(3)*T(4));
residual(39) = lhs - rhs;
lhs = y(22)*y(31)*(1+T(3)*T(4));
...
residual(48) = lhs - rhs;
lhs = y(48);
rhs = y(23)-y(21)*y(24)-T(28)-y(46)-y(47);
residual(49) = lhs - rhs;
lhs = y(64);
rhs = log(y(23));
residual(50) = lhs - rhs;
