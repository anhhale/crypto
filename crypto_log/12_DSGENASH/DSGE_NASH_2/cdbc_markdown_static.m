function [residual, g1, g2, g3] = cdbc_markdown_static(y, x, params)
%
...
T130 = y(15)^params(16);
T139 = params(35)^y(40);
T171 = params(38)*y(9)^(1-params(29))+params(39)*y(7)^(1-params(29));
T179 = y(3)^params(29);
T183 = y(7)^(-params(29));
T190 = (y(9)+y(7))^2;
T201 = y(9)^(-params(29));
T206 = y(44)/(y(9)+y(7))-1/(y(9)+y(7));
T233 = y(16)+params(9)*y(22)/y(19);
T247 = y(14)/y(5);
T248 = (y(12)+y(16)*params(12))/y(16)-T247;
T293 = sqrt((y(29)/(params(5)*y(27)))^2+(1/params(1))^2+y(48)*2*y(47)/(params(5)*y(27))+2*y(28)/(params(5)*y(27)));
T301 = params(17)/2*(y(5)-1)^2;
T302 = y(2)*T301;
T456 = y(3)-T31*params(8)/(1+params(7));
T465 = log(T456)-params(41)*(params(40)-y(44))^2+params(34)*y(8)^(1-params(31))/(1-params(31));
lhs =y(45)+y(43);
rhs =1/T34;
residual(1)= lhs-rhs;
lhs =y(42);
...
rhs =y(9)/(y(9)+y(7));
residual(20)= lhs-rhs;
lhs =y(43)*params(39)*T179*T183-params(41)*2*y(9)*(params(40)-y(44))/T190;
rhs =y(45)-y(39)*params(6)*y(45)/y(5);
residual(21)= lhs-rhs;
lhs =y(43)*params(38)*T179*T201-params(41)*2*(params(40)-y(44))*T206;
rhs =y(45)-params(6)*y(45)*params(37)/y(5);
residual(22)= lhs-rhs;
...
residual(24)= lhs-rhs;
lhs =1;
rhs =y(42)*(y(12)+y(16)*params(12))/T233;
residual(25)= lhs-rhs;
lhs =1;
rhs =y(42)*y(14)/y(5);
residual(26)= lhs-rhs;
...
residual(34)= lhs-rhs;
lhs =y(2);
rhs =y(36)+y(35)+y(20)+y(3)+y(4)*(1+y(33))+T302;
residual(35)= lhs-rhs;
lhs =y(10);
...
residual(47)= lhs-rhs;
lhs =y(37);
rhs =y(2)-y(15)*y(17)-T302-y(35)-y(36);
residual(48)= lhs-rhs;
lhs =y(51);
rhs =log(y(2));
residual(49)= lhs-rhs;
...
T487 = getPowerDeriv(y(3),params(29),1);
T531 = (-y(14))/(y(5)*y(5));
T557 = 1/y(5);
T567 = getPowerDeriv(T171,1/(1-params(29)),1);
T588 = params(41)*2*(params(40)-y(44))*((-y(44))/((y(9)+y(7))*(y(9)+y(7)))-(-1)/((y(9)+y(7))*(y(9)+y(7))));
T604 = (-(params(34)*getPowerDeriv(y(8),1-params(31),1)/(1-params(31))));
T672 = 1/R_ss__/(y(14)/R_ss__);
T736 = getPowerDeriv(y(18),1+params(7),1);
T756 = (-((-(params(8)/(1+params(7))*T736))/T456));
T821 = (y(34)+y(27)*T58*T64-(y(28)+y(24)*y(29)+y(47)*y(48)))*(y(34)+y(27)*T58*T64-(y(28)+y(24)*y(29)+y(47)*y(48)));
  g1(1,3)=(-((-1)/(T34*T34)));
  g1(1,18)=(-(params(8)*T736/(1+params(7))/(T34*T34)));
  g1(1,43)=1;
  g1(1,45)=1;
  g1(2,42)=1;
  ...
  g1(19,3)=1;
  g1(19,7)=(-(params(39)*getPowerDeriv(y(7),1-params(29),1)*T567));
  g1(19,9)=(-(T567*params(38)*getPowerDeriv(y(9),1-params(29),1)));
  g1(20,7)=(-((-y(9))/((y(9)+y(7))*(y(9)+y(7)))));
  g1(20,9)=(-((y(9)+y(7)-y(9))/((y(9)+y(7))*(y(9)+y(7)))));
  g1(20,44)=1;
  g1(21,3)=T183*y(43)*params(39)*T487;
  g1(21,5)=(-(y(39)*params(6)*y(45)))/(y(5)*y(5));
  g1(21,7)=y(43)*params(39)*T179*getPowerDeriv(y(7),(-params(29)),1)-params(41)*(-(2*y(9)*(params(40)-y(44))*2*(y(9)+y(7))))/(T190*T190);
  g1(21,9)=(-(params(41)*(T190*2*(params(40)-y(44))-2*y(9)*(params(40)-y(44))*2*(y(9)+y(7)))/(T190*T190)));
  g1(21,39)=params(6)*y(45)/y(5);
  g1(21,43)=params(39)*T179*T183;
  g1(21,44)=(-(params(41)*(-(2*y(9)))/T190));
  g1(21,45)=(-(1-params(6)*y(39)/y(5)));
  g1(22,3)=T201*y(43)*params(38)*T487;
  g1(22,5)=(-(params(6)*y(45)*params(37)))/(y(5)*y(5));
  g1(22,7)=(-T588);
  g1(22,9)=y(43)*params(38)*T179*getPowerDeriv(y(9),(-params(29)),1)-T588;
  g1(22,43)=params(38)*T179*T201;
  g1(22,44)=(-(params(41)*(T206*(-2)+2*(params(40)-y(44))*1/(y(9)+y(7)))));
  ...
  g1(25,12)=(-(y(42)/T233));
  g1(25,16)=(-((T233*y(42)*params(12)-y(42)*(y(12)+y(16)*params(12)))/(T233*T233)));
  g1(25,19)=(-((-(y(42)*(y(12)+y(16)*params(12))*(-(params(9)*y(22)))/(y(19)*y(19))))/(T233*T233)));
  g1(25,22)=(-((-(y(42)*(y(12)+y(16)*params(12))*params(9)/y(19)))/(T233*T233)));
  g1(25,42)=(-((y(12)+y(16)*params(12))/T233));
  ...
  g1(27,16)=1;
  g1(27,33)=(-1);
  g1(28,5)=(-(Omega__*(-T531)));
  g1(28,12)=(-(Omega__*1/y(16)));
  g1(28,14)=(-(Omega__*(-T557)));
  ...
  g1(29,5)=(-(Omega__*(T531-(-y(41))/(y(5)*y(5)))));
  g1(29,14)=(-(Omega__*T557));
  g1(29,25)=(-((T247-y(41)/y(5))*y(42)*params(3)));
  g1(29,41)=(-(Omega__*(-T557)));
  g1(29,42)=(-((1-params(3)+params(3)*y(25))*(T247-y(41)/y(5))));
  g1(29,47)=1;
  g1(30,5)=(-(Omega__*T531));
  g1(30,14)=(-(Omega__*T557));
  ...
  g1(32,26)=1;
  g1(32,27)=(-((y(34)+y(27)*T58*T64-(y(28)+y(24)*y(29)+y(47)*y(48))-y(27)*T58*T64)/T821));
  g1(32,28)=(-(y(27)/T821));
  ...
  g1(44,5)=(-((1-params(19))*params(20)*T557));
  g1(44,14)=T672-params(19)*T672;
