...
residual(7) = lhs - rhs;
lhs = y(18)*(y(18)-1);
rhs = 1/params(17)*(1+y(25)*params(13)-params(13))+T(14)*y(86)*(y(86)-1);
residual(8) = lhs - rhs;
lhs = y(16);
rhs = T(18)*T(19);
residual(9) = lhs - rhs;
...
rhs = y(22)/(y(20)+y(22));
residual(22) = lhs - rhs;
lhs = y(60)*params(39)*T(23)*T(24)-params(41)*2*y(22)*(params(40)-y(61))/T(25);
rhs = y(62)-y(54)*params(6)*y(92)/y(86);
residual(23) = lhs - rhs;
lhs = y(60)*params(38)*T(23)*T(26)-params(41)*2*(params(40)-y(61))*T(27);
rhs = y(62)-params(6)*y(92)*params(37)/y(86);
residual(24) = lhs - rhs;
lhs = params(34)*y(21)^(-params(31));
rhs = y(62)-y(56)*params(6)*y(92)/y(86);
residual(25) = lhs - rhs;
lhs = y(27);
rhs = params(8)*y(32)^params(7);
residual(26) = lhs - rhs;
lhs = 1;
rhs = y(57)*(y(88)+params(12)*y(90))/T(28);
residual(27) = lhs - rhs;
lhs = 1;
rhs = y(57)*y(28)/y(86);
residual(28) = lhs - rhs;
...
residual(35) = lhs - rhs;
lhs = y(39);
rhs = y(44)/(params(5)*y(42))-1/params(1)+T(34);
residual(36) = lhs - rhs;
lhs = y(16);
rhs = y(51)+y(50)+y(35)+y(17)+y(33)*(1+y(48))+T(36);
residual(37) = lhs - rhs;
lhs = y(23);
rhs = y(31)+y(9)*y(2)-y(35)/y(29);
residual(38) = lhs - rhs;
lhs = y(19);
rhs = params(3)*((y(26)+y(30)*params(12))*y(6)-y(7)*y(3)/y(18)-y(1)*y(13)/y(18)-y(2)*y(29)*y(9))+y(5)*(y(26)+y(30)*params(12))*params(4);
residual(39) = lhs - rhs;
...
residual(44) = lhs - rhs;
lhs = log(y(66));
rhs = log(T(37))+log(y(18));
residual(45) = lhs - rhs;
lhs = log(params(6)*y(28));
rhs = x(it_, 1)+(1-params(19))*(log(y(18))*params(20)+0.*log(T(38))+log(y(66))*params(49))+params(19)*log(params(6)*y(3));
residual(46) = lhs - rhs;
lhs = log(y(45));
...
residual(49) = lhs - rhs;
lhs = y(52);
rhs = y(16)-y(29)*y(31)-T(36)-y(50)-y(51);
residual(50) = lhs - rhs;
lhs = y(68);
rhs = log(y(16));
residual(51) = lhs - rhs;
