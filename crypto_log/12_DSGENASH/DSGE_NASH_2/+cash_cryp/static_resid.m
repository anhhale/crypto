...
residual(20) = lhs - rhs;
residual(21) = y(5);
residual(22) = params(6)*y(45)*params(37)/y(3)+y(43)-y(45);
...
residual(24) = lhs - rhs;
lhs = 1;
rhs = y(42)*(y(11)+y(15)*params(12))/T(21);
residual(25) = lhs - rhs;
lhs = 1;
rhs = y(42)*y(13)/y(3);
residual(26) = lhs - rhs;
...
residual(33) = lhs - rhs;
lhs = y(24);
rhs = y(29)/(params(5)*y(27))-1/params(1)+T(24);
residual(34) = lhs - rhs;
lhs = y(1);
rhs = y(36)+y(35)+y(20)+y(2)+y(18)*(1+y(33))+T(26);
residual(35) = lhs - rhs;
lhs = y(8);
...
residual(47) = lhs - rhs;
lhs = y(37);
rhs = y(1)-y(14)*y(16)-T(26)-y(35)-y(36);
residual(48) = lhs - rhs;
lhs = y(51);
rhs = log(y(1));
residual(49) = lhs - rhs;
