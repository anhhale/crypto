...
opt.grid{1,1}(1,2)={[0:0.1:2]};                 %grid for instrument 2 player 1 
opt.grid{1,1}(1,3)={[0:0.1:2.5]};               %grid for instrument 3 player 1 
...
opt.exclusion_condition{1,:}=['PHI_HEAD>0 && PHI_CORE>0'];
