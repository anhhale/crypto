...
T(30) = sqrt((y(29)/(params(5)*y(27)))^2+(1/params(1))^2+y(48)*2*y(47)/(params(5)*y(27))+2*y(28)/(params(5)*y(27)));
T(31) = params(17)/2*(y(3)-1)^2;
T(32) = y(1)*T(31);
T(33) = y(2)-T(2)*params(8)/(1+params(7));
T(34) = log(T(33))-params(41)*(params(40)-y(44))^2+params(34)*y(6)^(1-params(31))/(1-params(31));
