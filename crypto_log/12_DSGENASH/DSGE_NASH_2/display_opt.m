...
set_param_value('omega_pi',1.49*(1-0.8));
set_param_value('opt_ex',0.3*(1-0.8));
set_param_value('rho_i',0.8);
set_param_value('opt_star',0.1);
set_param_value('opt_c',0.1);
options_.order =2;
...
load param_macro_mon
set_param_value('rho_i',res_vk(1));
set_param_value('omega_pi',res_vk(2));
set_param_value('opt_ex',res_vk(3));
set_param_value('opt_star',res_vk(4));
set_param_value('opt_c',res_vk(5));
options_.order =2;
...
oo_osr = oo_;
rho_i=res_vk(1);
omega_pi =  res_vk(2)/(1-res_vk(1));
opt_ex = res_vk(3)/(1-res_vk(1));
opt_star = res_vk(4);
opt_c = res_vk(5);
load resosr
save resosr oo_bench oo_osr omega_pi opt_ex rho_i opt_star res_vk;
...
gamma_v = [omega_pi opt_ex rho_i opt_star opt_c]
