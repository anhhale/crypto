function [residual, g1, g2, g3] = cdbc_fix_static(y, x, params)
%
...
T130 = y(15)^params(16);
T139 = params(35)^y(40);
T168 = params(38)*y(9)^(1-params(29))+params(39)*y(7)^(1-params(29));
T176 = y(3)^params(29);
T180 = y(7)^(-params(29));
T187 = (y(9)+y(7))^2;
T198 = y(9)^(-params(29));
T203 = y(44)/(y(9)+y(7))-1/(y(9)+y(7));
T230 = y(16)+params(9)*y(22)/y(19);
T245 = y(14)/y(5);
T246 = (y(12)+y(16)*params(12))/y(16)-T245;
T291 = sqrt((y(29)/(params(5)*y(27)))^2+(1/params(1))^2+y(48)*2*y(47)/(params(5)*y(27))+2*y(28)/(params(5)*y(27)));
T299 = params(17)/2*(y(5)-1)^2;
T300 = y(2)*T299;
T454 = y(3)-T31*params(8)/(1+params(7));
T463 = log(T454)-params(41)*(params(40)-y(44))^2+params(34)*y(8)^(1-params(31))/(1-params(31));
lhs =y(45)+y(43);
rhs =1/T34;
residual(1)= lhs-rhs;
lhs =y(42);
...
rhs =y(9)/(y(9)+y(7));
residual(20)= lhs-rhs;
lhs =y(43)*params(39)*T176*T180-params(41)*2*y(9)*(params(40)-y(44))/T187;
rhs =y(45)-y(39)*params(6)*y(45)/y(5);
residual(21)= lhs-rhs;
lhs =y(43)*params(38)*T176*T198-params(41)*2*(params(40)-y(44))*T203;
...
residual(24)= lhs-rhs;
lhs =1;
rhs =y(42)*(y(12)+y(16)*params(12))/T230;
residual(25)= lhs-rhs;
lhs =1;
rhs =y(42)*y(14)/y(5);
residual(26)= lhs-rhs;
...
residual(34)= lhs-rhs;
lhs =y(2);
rhs =y(36)+y(35)+y(20)+y(3)+y(4)*(1+y(33))+T300;
residual(35)= lhs-rhs;
lhs =y(10);
...
residual(47)= lhs-rhs;
lhs =y(37);
rhs =y(2)-y(15)*y(17)-T300-y(35)-y(36);
residual(48)= lhs-rhs;
lhs =y(51);
rhs =log(y(2));
residual(49)= lhs-rhs;
...
T485 = getPowerDeriv(y(3),params(29),1);
T529 = (-y(14))/(y(5)*y(5));
T555 = 1/y(5);
T565 = getPowerDeriv(T168,1/(1-params(29)),1);
T586 = params(41)*2*(params(40)-y(44))*((-y(44))/((y(9)+y(7))*(y(9)+y(7)))-(-1)/((y(9)+y(7))*(y(9)+y(7))));
T602 = (-(params(34)*getPowerDeriv(y(8),1-params(31),1)/(1-params(31))));
T670 = 1/R_ss__/(y(14)/R_ss__);
T734 = getPowerDeriv(y(18),1+params(7),1);
T754 = (-((-(params(8)/(1+params(7))*T734))/T454));
T819 = (y(34)+y(27)*T58*T64-(y(28)+y(24)*y(29)+y(47)*y(48)))*(y(34)+y(27)*T58*T64-(y(28)+y(24)*y(29)+y(47)*y(48)));
  g1(1,3)=(-((-1)/(T34*T34)));
  g1(1,18)=(-(params(8)*T734/(1+params(7))/(T34*T34)));
  g1(1,43)=1;
  g1(1,45)=1;
  g1(2,42)=1;
  ...
  g1(19,3)=1;
  g1(19,7)=(-(params(39)*getPowerDeriv(y(7),1-params(29),1)*T565));
  g1(19,9)=(-(T565*params(38)*getPowerDeriv(y(9),1-params(29),1)));
  g1(20,7)=(-((-y(9))/((y(9)+y(7))*(y(9)+y(7)))));
  g1(20,9)=(-((y(9)+y(7)-y(9))/((y(9)+y(7))*(y(9)+y(7)))));
  g1(20,44)=1;
  g1(21,3)=T180*y(43)*params(39)*T485;
  g1(21,5)=(-(y(39)*params(6)*y(45)))/(y(5)*y(5));
  g1(21,7)=y(43)*params(39)*T176*getPowerDeriv(y(7),(-params(29)),1)-params(41)*(-(2*y(9)*(params(40)-y(44))*2*(y(9)+y(7))))/(T187*T187);
  g1(21,9)=(-(params(41)*(T187*2*(params(40)-y(44))-2*y(9)*(params(40)-y(44))*2*(y(9)+y(7)))/(T187*T187)));
  g1(21,39)=params(6)*y(45)/y(5);
  g1(21,43)=params(39)*T176*T180;
  g1(21,44)=(-(params(41)*(-(2*y(9)))/T187));
  g1(21,45)=(-(1-params(6)*y(39)/y(5)));
  g1(22,3)=T198*y(43)*params(38)*T485;
  g1(22,5)=(-(params(6)*y(45)*params(37)))/(y(5)*y(5));
  g1(22,7)=(-T586);
  g1(22,9)=y(43)*params(38)*T176*getPowerDeriv(y(9),(-params(29)),1)-T586;
  g1(22,43)=params(38)*T176*T198;
  g1(22,44)=(-(params(41)*(T203*(-2)+2*(params(40)-y(44))*1/(y(9)+y(7)))));
  ...
  g1(25,12)=(-(y(42)/T230));
  g1(25,16)=(-((T230*y(42)*params(12)-y(42)*(y(12)+y(16)*params(12)))/(T230*T230)));
  g1(25,19)=(-((-(y(42)*(y(12)+y(16)*params(12))*(-(params(9)*y(22)))/(y(19)*y(19))))/(T230*T230)));
  g1(25,22)=(-((-(y(42)*(y(12)+y(16)*params(12))*params(9)/y(19)))/(T230*T230)));
  g1(25,42)=(-((y(12)+y(16)*params(12))/T230));
  ...
  g1(27,16)=1;
  g1(27,33)=(-1);
  g1(28,5)=(-(Omega__*(-T529)));
  g1(28,12)=(-(Omega__*1/y(16)));
  g1(28,14)=(-(Omega__*(-T555)));
  ...
  g1(29,5)=(-(Omega__*(T529-(-y(41))/(y(5)*y(5)))));
  g1(29,14)=(-(Omega__*T555));
  g1(29,25)=(-((T245-y(41)/y(5))*y(42)*params(3)));
  g1(29,41)=(-(Omega__*(-T555)));
  g1(29,42)=(-((1-params(3)+params(3)*y(25))*(T245-y(41)/y(5))));
  g1(29,47)=1;
  g1(30,5)=(-(Omega__*T529));
  g1(30,14)=(-(Omega__*T555));
  ...
  g1(32,26)=1;
  g1(32,27)=(-((y(34)+y(27)*T58*T64-(y(28)+y(24)*y(29)+y(47)*y(48))-y(27)*T58*T64)/T819));
  g1(32,28)=(-(y(27)/T819));
  ...
  g1(44,5)=(-((1-params(19))*params(20)*T555));
  g1(44,14)=T670-params(19)*T670;
