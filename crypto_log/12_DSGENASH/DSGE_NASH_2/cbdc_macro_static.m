function [residual, g1, g2] = cbdc_macro_static(y, x, params)
%
...
T168 = params(38)*y(7)^(1-params(29))+params(39)*y(5)^(1-params(29));
T180 = y(5)^(-params(29));
T187 = (y(7)+y(5))^2;
T198 = y(7)^(-params(29));
T203 = y(44)/(y(7)+y(5))-1/(y(7)+y(5));
T230 = y(15)+params(9)*y(22)/y(19);
T246 = (y(11)+y(15)*params(12))/y(15)-y(13)/y(3);
T255 = y(13)*(1-y(51))/y(3)-y(41)/y(3);
T263 = y(13)*(1-y(52))/y(3)-y(31);
T271 = T58*T64;
T299 = sqrt((y(29)/(params(5)*y(27)))^2+(1/params(1))^2+y(48)*2*y(47)/(params(5)*y(27))+2*y(28)/(params(5)*y(27)));
T307 = params(17)/2*(y(3)-1)^2;
T308 = y(1)*T307;
T470 = y(2)-y(17)^(1+params(7))*params(8)/(1+params(7));
T479 = log(T470)-params(41)*(params(40)-y(44))^2+params(34)*y(6)^(1-params(31))/(1-params(31));
T567 = getPowerDeriv(T168,1/(1-params(29)),1);
T588 = params(41)*2*(params(40)-y(44))*((-y(44))/((y(7)+y(5))*(y(7)+y(5)))-(-1)/((y(7)+y(5))*(y(7)+y(5))));
T604 = (-(params(34)*getPowerDeriv(y(6),1-params(31),1)/(1-params(31))));
T677 = 1/R_ss__/(y(13)/R_ss__);
T761 = (-((-(params(8)/(1+params(7))*getPowerDeriv(y(17),1+params(7),1)))/T470));
T821 = 1/y(21)-1/(y(21));
T848 = (y(34)+y(27)*T271-(y(28)+y(24)*y(29)+y(47)*y(48)))*(y(34)+y(27)*T271-(y(28)+y(24)*y(29)+y(47)*y(48)));
lhs =y(45)+y(43);
rhs =1/T34;
residual(1)= lhs-rhs;
lhs =y(42);
...
residual(18)= lhs-rhs;
lhs =y(2);
rhs =T168^(1/(1-params(29)));
residual(19)= lhs-rhs;
lhs =y(44);
rhs =y(7)/(y(7)+y(5));
residual(20)= lhs-rhs;
lhs =y(43)*params(39)*y(2)^params(29)*T180-params(41)*2*y(7)*(params(40)-y(44))/T187;
rhs =y(45)-y(39)*params(6)*y(45)/y(3);
residual(21)= lhs-rhs;
lhs =y(43)*params(38)*y(2)^params(29)*T198-params(41)*2*(params(40)-y(44))*T203;
...
residual(24)= lhs-rhs;
lhs =1;
rhs =y(42)*(y(11)+y(15)*params(12))/T230;
residual(25)= lhs-rhs;
lhs =1;
rhs =y(42)*y(13)/y(3);
residual(26)= lhs-rhs;
...
residual(31)= lhs-rhs;
lhs =y(26);
rhs =y(27)/(y(34)+y(27)*T271-(y(28)+y(24)*y(29)+y(47)*y(48)));
residual(32)= lhs-rhs;
lhs =y(25);
rhs =y(34)*y(26);
residual(33)= lhs-rhs;
lhs =y(24);
rhs =y(29)/(params(5)*y(27))-1/params(1)+T299;
residual(34)= lhs-rhs;
lhs =y(1);
rhs =y(36)+y(35)+y(20)+y(2)+y(18)*(1+y(33))+T308;
residual(35)= lhs-rhs;
lhs =y(8);
...
residual(43)= lhs-rhs;
lhs =log(y(13)/R_ss__);
rhs =log(y(3))*params(20)+0.*log(y(1)/(y(1)))+log(y(49))*params(49)+log(y(13)/R_ss__)*params(19)+x(1);
residual(44)= lhs-rhs;
lhs =log(y(30));
...
residual(47)= lhs-rhs;
lhs =y(51);
rhs =params(52)*(log(y(21))-log((y(21))));
residual(48)= lhs-rhs;
lhs =y(52);
rhs =(log(y(21))-log((y(21))))*params(51);
residual(49)= lhs-rhs;
lhs =y(37);
rhs =y(1)-y(14)*y(16)-T308-y(35)-y(36);
residual(50)= lhs-rhs;
lhs =y(53);
rhs =log(y(1));
residual(51)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(19,2)=1;
  g1(19,5)=(-(params(39)*getPowerDeriv(y(5),1-params(29),1)*T567));
  g1(19,7)=(-(T567*params(38)*getPowerDeriv(y(7),1-params(29),1)));
  g1(20,5)=(-((-y(7))/((y(7)+y(5))*(y(7)+y(5)))));
  g1(20,7)=(-((y(7)+y(5)-y(7))/((y(7)+y(5))*(y(7)+y(5)))));
  g1(20,44)=1;
  g1(21,2)=T180*y(43)*params(39)*getPowerDeriv(y(2),params(29),1);
  g1(21,3)=(-(y(39)*params(6)*y(45)))/(y(3)*y(3));
  g1(21,5)=y(43)*params(39)*y(2)^params(29)*getPowerDeriv(y(5),(-params(29)),1)-params(41)*(-(2*y(7)*(params(40)-y(44))*2*(y(7)+y(5))))/(T187*T187);
  g1(21,7)=(-(params(41)*(T187*2*(params(40)-y(44))-2*y(7)*(params(40)-y(44))*2*(y(7)+y(5)))/(T187*T187)));
  g1(21,39)=params(6)*y(45)/y(3);
  g1(21,43)=params(39)*y(2)^params(29)*T180;
  g1(21,44)=(-(params(41)*(-(2*y(7)))/T187));
  g1(21,45)=(-(1-params(6)*y(39)/y(3)));
  g1(22,2)=T198*y(43)*params(38)*getPowerDeriv(y(2),params(29),1);
  g1(22,3)=(-(params(6)*y(45)*params(37)))/(y(3)*y(3));
  g1(22,5)=(-T588);
  g1(22,7)=y(43)*params(38)*y(2)^params(29)*getPowerDeriv(y(7),(-params(29)),1)-T588;
  g1(22,43)=params(38)*y(2)^params(29)*T198;
  g1(22,44)=(-(params(41)*(T203*(-2)+2*(params(40)-y(44))*1/(y(7)+y(5)))));
  ...
  g1(25,11)=(-(y(42)/T230));
  g1(25,15)=(-((T230*y(42)*params(12)-y(42)*(y(11)+y(15)*params(12)))/(T230*T230)));
  g1(25,19)=(-((-(y(42)*(y(11)+y(15)*params(12))*(-(params(9)*y(22)))/(y(19)*y(19))))/(T230*T230)));
  g1(25,22)=(-((-(y(42)*(y(11)+y(15)*params(12))*params(9)/y(19)))/(T230*T230)));
  g1(25,42)=(-((y(11)+y(15)*params(12))/T230));
  ...
  g1(27,33)=(-1);
  g1(28,3)=(-(Omega__*(-((-y(13))/(y(3)*y(3))))));
  g1(28,11)=(-(Omega__*1/y(15)));
  g1(28,13)=(-(Omega__*(-(1/y(3)))));
  g1(28,15)=(-(Omega__*(y(15)*params(12)-(y(11)+y(15)*params(12)))/(y(15)*y(15))));
  g1(28,25)=(-(T246*y(42)*params(3)));
  g1(28,28)=1;
  g1(28,42)=(-((1-params(3)+params(3)*y(25))*T246));
  g1(29,3)=(-(Omega__*((-(y(13)*(1-y(51))))/(y(3)*y(3))-(-y(41))/(y(3)*y(3)))));
  g1(29,13)=(-(Omega__*(1-y(51))/y(3)));
  g1(29,25)=(-(T255*y(42)*params(3)));
  g1(29,41)=(-(Omega__*(-(1/y(3)))));
  g1(29,42)=(-((1-params(3)+params(3)*y(25))*T255));
  g1(29,47)=1;
  g1(29,51)=(-(Omega__*(-y(13))/y(3)));
  g1(30,3)=(-(Omega__*(-(y(13)*(1-y(52))))/(y(3)*y(3))));
  g1(30,13)=(-(Omega__*(1-y(52))/y(3)));
  g1(30,25)=(-(T263*y(42)*params(3)));
  g1(30,29)=1;
  g1(30,31)=Omega__;
  g1(30,42)=(-((1-params(3)+params(3)*y(25))*T263));
  g1(30,52)=(-(Omega__*(-y(13))/y(3)));
  ...
  g1(32,24)=(-((-(y(27)*(y(27)*T58*2*y(24)-y(29))))/T848));
  g1(32,26)=1;
  g1(32,27)=(-((y(34)+y(27)*T271-(y(28)+y(24)*y(29)+y(47)*y(48))-y(27)*T271)/T848));
  g1(32,28)=(-(y(27)/T848));
  g1(32,29)=(-((-(y(27)*(-y(24))))/T848));
  g1(32,34)=(-((-y(27))/T848));
  g1(32,47)=(-((-(y(27)*(-y(48))))/T848));
  g1(32,48)=(-((-(y(27)*(-y(47))))/T848));
  g1(33,25)=1;
  g1(33,26)=(-y(34));
  g1(33,34)=(-y(26));
  g1(34,24)=1;
  g1(34,27)=(-((-(params(5)*y(29)))/(params(5)*y(27)*params(5)*y(27))+((-(params(5)*y(29)))/(params(5)*y(27)*params(5)*y(27))*2*y(29)/(params(5)*y(27))+y(48)*(-(params(5)*2*y(47)))/(params(5)*y(27)*params(5)*y(27))+(-(params(5)*2*y(28)))/(params(5)*y(27)*params(5)*y(27)))/(T299+T299)));
  g1(34,28)=(-(2/(params(5)*y(27))/(T299+T299)));
  g1(34,29)=(-(1/(params(5)*y(27))+2*y(29)/(params(5)*y(27))*1/(params(5)*y(27))/(T299+T299)));
  g1(34,47)=(-(y(48)*2/(params(5)*y(27))/(T299+T299)));
  g1(34,48)=(-(2*y(47)/(params(5)*y(27))/(T299+T299)));
  g1(35,1)=1-T307;
  g1(35,2)=(-1);
  ...
  g1(37,23)=(-(params(3)*(-(y(13)/y(3)))));
  g1(37,31)=(-(params(3)*(-(y(14)*y(8)))));
  g1(37,41)=(-(params(3)*(-(y(6)/y(3)))));
  g1(38,4)=(-(y(26)*(1+T271)));
  g1(38,15)=y(21)*(1+T271);
  g1(38,21)=y(15)*(1+T271);
  ...
  g1(39,8)=(-y(14));
  g1(39,14)=(-y(8));
  g1(39,15)=y(21)*(1+T271);
  g1(39,21)=y(15)*(1+T271);
  g1(39,23)=(-1);
  ...
  g1(43,3)=(-(1/y(3)));
  g1(43,49)=1/y(49);
  g1(44,1)=(-(0.*((y(1))-y(1))/((y(1))*(y(1)))/(y(1)/(y(1)))));
  g1(44,3)=(-(params(20)*1/y(3)));
  g1(44,13)=T677-params(19)*T677;
  g1(44,49)=(-(params(49)*1/y(49)));
  g1(45,30)=T72-T72*params(21);
  g1(46,32)=1-(params(23)+1-params(23));
  g1(47,31)=1-(params(22)+1-params(22));
  g1(48,21)=(-(params(52)*T821));
  g1(48,51)=1;
  g1(49,21)=(-(params(51)*T821));
  g1(49,52)=1;
  g1(50,1)=(-(1-T307));
  ...
  g1(68,6)=T604;
  g1(68,17)=T761;
  g1(68,44)=params(41)*(-(2*(params(40)-y(44))));
  g1(68,50)=1;
  g1(69,2)=(-(1/T470));
  g1(69,6)=T604;
  g1(69,9)=1-params(6);
  g1(69,17)=T761;
  g1(69,44)=params(41)*(-(2*(params(40)-y(44))));
  if ~isreal(g1)
