...
residual(33) = lhs - rhs;
lhs = y(24);
rhs = y(29)/(params(5)*y(27))-1/params(1)+T(31);
residual(34) = lhs - rhs;
lhs = y(1);
rhs = y(36)+y(35)+y(20)+y(2)+y(18)*(1+y(33))+T(33);
residual(35) = lhs - rhs;
lhs = y(8);
...
rhs = x(1)+log(y(3))*params(20)+0.*log(y(1)/(y(1)))+log(y(49))*params(49)+log(params(6)*y(13))*params(19);
residual(44) = lhs - rhs;
lhs = log(y(30));
...
residual(49) = lhs - rhs;
lhs = y(37);
rhs = y(1)-y(14)*y(16)-T(33)-y(35)-y(36);
residual(50) = lhs - rhs;
lhs = y(53);
rhs = log(y(1));
residual(51) = lhs - rhs;
