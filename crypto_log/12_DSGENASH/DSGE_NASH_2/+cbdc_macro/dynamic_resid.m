...
residual(7) = lhs - rhs;
lhs = y(17)*(y(17)-1);
rhs = 1/params(17)*(1+y(24)*params(13)-params(13))+T(14)*y(85)*(y(85)-1);
residual(8) = lhs - rhs;
lhs = y(15);
rhs = T(18)*T(19);
residual(9) = lhs - rhs;
...
residual(24) = lhs - rhs;
lhs = 1;
rhs = y(56)*(y(87)+params(12)*y(89))/T(28);
residual(25) = lhs - rhs;
lhs = 1;
rhs = y(56)*y(27)/y(85);
residual(26) = lhs - rhs;
lhs = y(29);
rhs = 1+y(47)+T(40)*params(15)*y(32)/(steady_state(18));
residual(27) = lhs - rhs;
lhs = y(42);
rhs = T(4)*T(29);
residual(28) = lhs - rhs;
...
residual(33) = lhs - rhs;
lhs = y(38);
rhs = y(43)/(params(5)*y(41))-1/params(1)+T(33);
residual(34) = lhs - rhs;
lhs = y(15);
rhs = y(50)+y(49)+y(34)+y(16)+y(32)*(1+y(47))+T(35);
residual(35) = lhs - rhs;
lhs = y(22);
...
residual(42) = lhs - rhs;
lhs = log(y(63));
rhs = log(T(36))+log(y(17));
residual(43) = lhs - rhs;
lhs = log(params(6)*y(27));
rhs = x(it_, 1)+log(y(17))*params(20)+0.*log(T(37))+log(y(63))*params(49)+params(19)*log(params(6)*y(3));
residual(44) = lhs - rhs;
lhs = log(y(44));
...
residual(49) = lhs - rhs;
lhs = y(51);
rhs = y(15)-y(28)*y(30)-T(35)-y(49)-y(50);
residual(50) = lhs - rhs;
lhs = y(67);
rhs = log(y(15));
residual(51) = lhs - rhs;
