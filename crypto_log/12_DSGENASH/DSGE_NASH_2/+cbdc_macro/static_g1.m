...
g1 = zeros(69, 69);
g1(1,2)=(-((-1)/(T(3)*T(3))));
g1(1,17)=(-(params(8)*T(40)/(1+params(7))/(T(3)*T(3))));
g1(1,43)=1;
g1(1,45)=1;
g1(2,42)=1;
...
g1(19,2)=1;
g1(19,5)=(-(params(39)*getPowerDeriv(y(5),1-params(29),1)*T(37)));
g1(19,7)=(-(T(37)*params(38)*getPowerDeriv(y(7),1-params(29),1)));
...
g1(22,5)=(-T(38));
g1(22,7)=y(43)*params(38)*T(22)*getPowerDeriv(y(7),(-params(29)),1)-T(38);
...
g1(27,33)=(-1);
g1(28,3)=(-(T(1)*(-((-y(13))/(y(3)*y(3))))));
g1(28,11)=(-(T(1)*1/y(15)));
g1(28,13)=(-(T(1)*(-(1/y(3)))));
g1(28,15)=(-(T(1)*(y(15)*params(12)-(y(11)+y(15)*params(12)))/(y(15)*y(15))));
g1(28,25)=(-(T(28)*y(42)*params(3)));
g1(28,28)=1;
g1(28,42)=(-((1-params(3)+params(3)*y(25))*T(28)));
g1(29,3)=(-(T(1)*((-(y(13)*(1-y(51))))/(y(3)*y(3))-(-y(41))/(y(3)*y(3)))));
g1(29,13)=(-(T(1)*(1-y(51))/y(3)));
g1(29,25)=(-(T(29)*y(42)*params(3)));
g1(29,41)=(-(T(1)*(-(1/y(3)))));
g1(29,42)=(-((1-params(3)+params(3)*y(25))*T(29)));
g1(29,47)=1;
g1(29,51)=(-(T(1)*(-y(13))/y(3)));
g1(30,3)=(-(T(1)*(-(y(13)*(1-y(52))))/(y(3)*y(3))));
g1(30,13)=(-(T(1)*(1-y(52))/y(3)));
g1(30,25)=(-(T(30)*y(42)*params(3)));
g1(30,29)=1;
g1(30,31)=T(1);
g1(30,42)=(-((1-params(3)+params(3)*y(25))*T(30)));
g1(30,52)=(-(T(1)*(-y(13))/y(3)));
...
g1(33,34)=(-y(26));
g1(34,24)=1;
g1(34,27)=(-((-(params(5)*y(29)))/(params(5)*y(27)*params(5)*y(27))+((-(params(5)*y(29)))/(params(5)*y(27)*params(5)*y(27))*2*y(29)/(params(5)*y(27))+y(48)*(-(params(5)*2*y(47)))/(params(5)*y(27)*params(5)*y(27))+(-(params(5)*2*y(28)))/(params(5)*y(27)*params(5)*y(27)))/(T(31)+T(31))));
g1(34,28)=(-(2/(params(5)*y(27))/(T(31)+T(31))));
g1(34,29)=(-(1/(params(5)*y(27))+2*y(29)/(params(5)*y(27))*1/(params(5)*y(27))/(T(31)+T(31))));
g1(34,47)=(-(y(48)*2/(params(5)*y(27))/(T(31)+T(31))));
g1(34,48)=(-(2*y(47)/(params(5)*y(27))/(T(31)+T(31))));
g1(35,1)=1-T(32);
g1(35,2)=(-1);
...
g1(48,21)=(-(params(52)*T(42)));
g1(48,51)=1;
g1(49,21)=(-(params(51)*T(42)));
g1(49,52)=1;
g1(50,1)=(-(1-T(32)));
