...
if T_flag
    T = ABK2016.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(33, 1);
lhs = y(37);
...
residual(5) = lhs - rhs;
lhs = y(10)*(y(10)-1);
rhs = 1/params(17)*(1+y(9)*params(13)-params(13))+(y(42)-1)*y(42)*T(3)*y(46)/y(16);
residual(6) = lhs - rhs;
lhs = y(16);
rhs = T(15)*T(16);
residual(7) = lhs - rhs;
...
residual(14) = lhs - rhs;
lhs = y(15);
rhs = 1+y(37)+T(26)*params(15)*y(20)/(steady_state(12));
residual(15) = lhs - rhs;
lhs = y(32);
rhs = T(19)*T(27);
residual(16) = lhs - rhs;
...
residual(23) = lhs - rhs;
lhs = y(23);
rhs = (params(3)+params(4))*(y(11)+y(15)*params(12))*y(3)-params(3)*y(4)*y(1)/y(10)-y(5)*y(7)*params(3)*y(14);
residual(24) = lhs - rhs;
lhs = y(15)*y(24)*T(25);
rhs = y(23)*y(30)*T(25);
residual(25) = lhs - rhs;
