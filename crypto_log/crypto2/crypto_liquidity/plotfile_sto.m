...
legend('\rho^{DC} = 2','\rho^{DC} = 6','\rho^{DC}= 0.5','Location','best','FontSize',7);
legend boxoff
...
legend boxoff
orient landscape
print('monetary_liq','-dpdf','-fillpage')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
legend boxoff
orient landscape
print('foreign_liq','-dpdf','-fillpage')
