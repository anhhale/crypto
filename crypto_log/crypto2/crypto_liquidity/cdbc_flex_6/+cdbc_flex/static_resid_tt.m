...
T(18) = y(6)^params(16);
T(19) = params(35)^y(36);
T(20) = params(38)*y(39)^(1-params(29))+params(39)*y(38)^(1-params(29));
T(21) = y(11)^params(29);
T(22) = y(38)^(-params(29));
T(23) = (y(39)+y(38))^2;
T(24) = y(39)^(-params(29));
T(25) = y(43)/(y(39)+y(38))-1/(y(39)+y(38));
T(26) = y(7)+params(9)*y(17)/y(13);
T(27) = y(5)/y(2);
T(28) = (y(3)+y(7)*params(12))/y(7)-T(27);
T(29) = sqrt((y(25)/(params(5)*y(23)))^2+(1/params(1))^2+y(47)*2*y(46)/(params(5)*y(23))+2*y(24)/(params(5)*y(23)));
