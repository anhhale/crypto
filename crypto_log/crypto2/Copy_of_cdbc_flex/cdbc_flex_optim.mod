...
// Additional params
            ...
            Gamma
            chi_dc
trs_ss m_ss DC_ss Lambda_ss gam_ss opt_pi opt_y opt_ex  opt_rho
;
...
set_param_value('c_share',c_share);
           opt_pi= 1.49;
 opt_y= 0.26; opt_ex=0.3; opt_rho=0.8;
      theta = 0.401;
            theta_0 = 0.401; %0.399;
            sigma = 0.94;
            xi = 0.0045; %0.0046;
...
ln(R_dc)=(1-0.92)*ln(R_dc(-1)) +0.92*(opt_pi*ln(Pi) + opt_y*ln(Y/steady_state(Y)));%flex
