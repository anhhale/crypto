function [residual, g1, g2, g3] = cdbc_flex_optim_static(y, x, params)
%
...
T31 = y(17)^(1+params(7));
T34 = y(2)-params(8)*T31/(1+params(7));
T43 = y(18)/I_ss__-1;
...
T315 = y(1)*T314;
T465 = y(2)-T31*params(8)/(1+params(7));
...
residual(15)= lhs-rhs;
lhs =log(y(39));
rhs =log(y(39))*0.07999999999999996+0.92*(params(47)*log(y(3))+params(48)*log(y(1)/(y(1))));
residual(16)= lhs-rhs;
lhs =y(41);
rhs =1;
residual(17)= lhs-rhs;
...
rhs =y(7)/(y(7)+y(5));
residual(20)= lhs-rhs;
lhs =y(43)*params(39)*T191*T195-params(41)*2*y(7)*(params(40)-y(44))/T202;
rhs =y(45)-y(39)*params(6)*y(45)/y(3);
residual(21)= lhs-rhs;
lhs =y(43)*params(38)*T191*T213-params(41)*2*(params(40)-y(44))*T218;
...
T498 = getPowerDeriv(y(2),params(29),1);
T513 = 1/y(3);
T531 = (-y(13))/(y(3)*y(3));
...
T736 = getPowerDeriv(y(17),1+params(7),1);
T756 = (-((-(params(8)/(1+params(7))*T736))/T465));
T836 = (y(34)+y(27)*T58*T64-(y(28)+y(24)*y(29)+y(47)*y(48)))*(y(34)+y(27)*T58*T64-(y(28)+y(24)*y(29)+y(47)*y(48)));
  g1(1,2)=(-((-1)/(T34*T34)));
  g1(1,17)=(-(params(8)*T736/(1+params(7))/(T34*T34)));
  g1(1,43)=1;
  g1(1,45)=1;
  g1(2,42)=1;
  ...
  g1(16,1)=(-(0.92*params(48)*T484));
  g1(16,3)=(-(0.92*params(47)*T513));
  ...
  g1(20,44)=1;
  g1(21,2)=T195*y(43)*params(39)*T498;
  g1(21,3)=(-(y(39)*params(6)*y(45)))/(y(3)*y(3));
  g1(21,5)=y(43)*params(39)*T191*getPowerDeriv(y(5),(-params(29)),1)-params(41)*(-(2*y(7)*(params(40)-y(44))*2*(y(7)+y(5))))/(T202*T202);
  g1(21,7)=(-(params(41)*(T202*2*(params(40)-y(44))-2*y(7)*(params(40)-y(44))*2*(y(7)+y(5)))/(T202*T202)));
  g1(21,39)=params(6)*y(45)/y(3);
  g1(21,43)=params(39)*T191*T195;
  g1(21,44)=(-(params(41)*(-(2*y(7)))/T202));
  g1(21,45)=(-(1-params(6)*y(39)/y(3)));
  g1(22,2)=T213*y(43)*params(38)*T498;
  g1(22,3)=(-(params(6)*y(45)*params(37)))/(y(3)*y(3));
  g1(22,5)=(-T587);
  g1(22,7)=y(43)*params(38)*T191*getPowerDeriv(y(7),(-params(29)),1)-T587;
  g1(22,43)=params(38)*T191*T213;
  ...
  g1(32,26)=1;
  g1(32,27)=(-((y(34)+y(27)*T58*T64-(y(28)+y(24)*y(29)+y(47)*y(48))-y(27)*T58*T64)/T836));
  g1(32,28)=(-(y(27)/T836));
