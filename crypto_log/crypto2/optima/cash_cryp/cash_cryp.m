...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('cash_cryp_static');
erase_compiled_function('cash_cryp_dynamic');
...
M_.NNZDerivatives(1) = 259;
M_.NNZDerivatives(2) = 465;
...
save('cash_cryp_results.mat', 'oo_', 'M_', 'options_');
