function [residual, g1, g2] = cash_cryp_static(y, x, params)
%
...
T269 = params(17)/2*(y(3)-1)^2;
T270 = y(1)*T269;
T421 = y(2)-y(17)^(1+params(7))*params(8)/(1+params(7));
T430 = log(T421)-params(41)*(params(40)-y(44))^2+params(34)*y(6)^(1-params(31))/(1-params(31));
T469 = (-y(13))/(y(3)*y(3));
T495 = 1/y(3);
T510 = (-(params(41)*2*(params(40)-y(44))*((-y(44))/((y(7)+y(5))*(y(7)+y(5)))-(-1)/((y(7)+y(5))*(y(7)+y(5))))));
T523 = (-(params(34)*getPowerDeriv(y(6),1-params(31),1)/(1-params(31))));
T577 = 1/R_ss__/(y(13)/R_ss__);
T661 = (-((-(params(8)/(1+params(7))*getPowerDeriv(y(17),1+params(7),1)))/T421));
T741 = (y(34)+y(27)*T233-(y(28)+y(24)*y(29)+y(47)*y(48)))*(y(34)+y(27)*T233-(y(28)+y(24)*y(29)+y(47)*y(48)));
lhs =y(45)+y(43);
rhs =1/T34;
residual(1)= lhs-rhs;
lhs =y(42);
...
residual(20)= lhs-rhs;
residual(21) = y(5);
residual(22) = y(43)-params(41)*2*(params(40)-y(44))*T171-y(45)+params(6)*y(45)*params(37)/y(3);
...
residual(31)= lhs-rhs;
lhs =y(26);
rhs =y(27)/(y(34)+y(27)*T233-(y(28)+y(24)*y(29)+y(47)*y(48)));
residual(32)= lhs-rhs;
lhs =y(25);
rhs =y(34)*y(26);
residual(33)= lhs-rhs;
...
residual(34)= lhs-rhs;
lhs =y(1);
rhs =y(36)+y(35)+y(20)+y(2)+y(18)*(1+y(33))+T270;
residual(35)= lhs-rhs;
lhs =y(8);
...
residual(47)= lhs-rhs;
lhs =y(37);
rhs =y(1)-y(14)*y(16)-T270-y(35)-y(36);
residual(48)= lhs-rhs;
lhs =y(51);
rhs =log(y(1));
residual(49)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(22,7)=T510;
  g1(22,43)=1;
  g1(22,44)=(-(params(41)*(T171*(-2)+2*(params(40)-y(44))*1/(y(7)+y(5)))));
  ...
  g1(27,33)=(-1);
  g1(28,3)=(-(Omega__*(-T469)));
  g1(28,11)=(-(Omega__*1/y(15)));
  g1(28,13)=(-(Omega__*(-T495)));
  ...
  g1(29,3)=(-(Omega__*(T469-(-y(41))/(y(3)*y(3)))));
  g1(29,13)=(-(Omega__*T495));
  g1(29,25)=(-((T215-y(41)/y(3))*y(42)*params(3)));
  g1(29,41)=(-(Omega__*(-T495)));
  g1(29,42)=(-((1-params(3)+params(3)*y(25))*(T215-y(41)/y(3))));
  g1(29,47)=1;
  g1(30,3)=(-(Omega__*T469));
  g1(30,13)=(-(Omega__*T495));
  ...
  g1(32,26)=1;
  g1(32,27)=(-((y(34)+y(27)*T233-(y(28)+y(24)*y(29)+y(47)*y(48))-y(27)*T233)/T741));
  g1(32,28)=(-(y(27)/T741));
  ...
  g1(38,4)=(-(y(26)*(1+T233)));
  g1(38,15)=y(21)*(1+T233);
  g1(38,21)=y(15)*(1+T233);
  ...
  g1(39,8)=(-y(14));
  g1(39,14)=(-y(8));
  g1(39,15)=y(21)*(1+T233);
  g1(39,21)=y(15)*(1+T233);
  g1(39,23)=(-1);
  ...
  g1(44,3)=(-((1-params(19))*params(20)*T495));
