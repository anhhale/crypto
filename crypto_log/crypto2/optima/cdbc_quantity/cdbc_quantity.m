...
M_.endo_names = char(M_.endo_names, 'DC_sup');
M_.endo_names_tex = char(M_.endo_names_tex, 'DC\_sup');
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('cdbc_quantity_static');
erase_compiled_function('cdbc_quantity_dynamic');
...
save('cdbc_quantity_results.mat', 'oo_', 'M_', 'options_');
