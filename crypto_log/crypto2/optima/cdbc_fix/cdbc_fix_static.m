function [residual, g1, g2] = cdbc_fix_static(y, x, params)
%
...
T245 = y(13)/y(3);
T246 = (y(11)+y(15)*params(12))/y(15)-T245;
T263 = T58*T64;
T291 = sqrt((y(29)/(params(5)*y(27)))^2+(1/params(1))^2+y(48)*2*y(47)/(params(5)*y(27))+2*y(28)/(params(5)*y(27)));
T299 = params(17)/2*(y(3)-1)^2;
T300 = y(1)*T299;
T454 = y(2)-y(17)^(1+params(7))*params(8)/(1+params(7));
T463 = log(T454)-params(41)*(params(40)-y(44))^2+params(34)*y(6)^(1-params(31))/(1-params(31));
T513 = (-y(13))/(y(3)*y(3));
T539 = 1/y(3);
T549 = getPowerDeriv(T168,1/(1-params(29)),1);
T570 = params(41)*2*(params(40)-y(44))*((-y(44))/((y(7)+y(5))*(y(7)+y(5)))-(-1)/((y(7)+y(5))*(y(7)+y(5))));
T586 = (-(params(34)*getPowerDeriv(y(6),1-params(31),1)/(1-params(31))));
T655 = 1/R_ss__/(y(13)/R_ss__);
T739 = (-((-(params(8)/(1+params(7))*getPowerDeriv(y(17),1+params(7),1)))/T454));
T819 = (y(34)+y(27)*T263-(y(28)+y(24)*y(29)+y(47)*y(48)))*(y(34)+y(27)*T263-(y(28)+y(24)*y(29)+y(47)*y(48)));
lhs =y(45)+y(43);
rhs =1/T34;
residual(1)= lhs-rhs;
lhs =y(42);
...
residual(28)= lhs-rhs;
lhs =y(47);
rhs =Omega__*(T245-y(41)/y(3));
residual(29)= lhs-rhs;
lhs =y(29);
rhs =Omega__*(T245-y(31));
residual(30)= lhs-rhs;
lhs =y(27);
rhs =y(13)*Omega__/y(3);
residual(31)= lhs-rhs;
lhs =y(26);
rhs =y(27)/(y(34)+y(27)*T263-(y(28)+y(24)*y(29)+y(47)*y(48)));
residual(32)= lhs-rhs;
lhs =y(25);
rhs =y(34)*y(26);
residual(33)= lhs-rhs;
lhs =y(24);
rhs =y(29)/(params(5)*y(27))-1/params(1)+T291;
residual(34)= lhs-rhs;
lhs =y(1);
rhs =y(36)+y(35)+y(20)+y(2)+y(18)*(1+y(33))+T300;
residual(35)= lhs-rhs;
lhs =y(8);
...
residual(47)= lhs-rhs;
lhs =y(37);
rhs =y(1)-y(14)*y(16)-T300-y(35)-y(36);
residual(48)= lhs-rhs;
lhs =y(51);
rhs =log(y(1));
residual(49)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(19,2)=1;
  g1(19,5)=(-(params(39)*getPowerDeriv(y(5),1-params(29),1)*T549));
  g1(19,7)=(-(T549*params(38)*getPowerDeriv(y(7),1-params(29),1)));
  ...
  g1(22,5)=(-T570);
  g1(22,7)=y(43)*params(38)*y(2)^params(29)*getPowerDeriv(y(7),(-params(29)),1)-T570;
  ...
  g1(27,33)=(-1);
  g1(28,3)=(-(Omega__*(-T513)));
  g1(28,11)=(-(Omega__*1/y(15)));
  g1(28,13)=(-(Omega__*(-T539)));
  ...
  g1(29,3)=(-(Omega__*(T513-(-y(41))/(y(3)*y(3)))));
  g1(29,13)=(-(Omega__*T539));
  g1(29,25)=(-((T245-y(41)/y(3))*y(42)*params(3)));
  g1(29,41)=(-(Omega__*(-T539)));
  g1(29,42)=(-((1-params(3)+params(3)*y(25))*(T245-y(41)/y(3))));
  g1(29,47)=1;
  g1(30,3)=(-(Omega__*T513));
  g1(30,13)=(-(Omega__*T539));
  g1(30,25)=(-((T245-y(31))*y(42)*params(3)));
  g1(30,29)=1;
  g1(30,31)=Omega__;
  g1(30,42)=(-((1-params(3)+params(3)*y(25))*(T245-y(31))));
  ...
  g1(32,24)=(-((-(y(27)*(y(27)*T58*2*y(24)-y(29))))/T819));
  g1(32,26)=1;
  g1(32,27)=(-((y(34)+y(27)*T263-(y(28)+y(24)*y(29)+y(47)*y(48))-y(27)*T263)/T819));
  g1(32,28)=(-(y(27)/T819));
  g1(32,29)=(-((-(y(27)*(-y(24))))/T819));
  g1(32,34)=(-((-y(27))/T819));
  g1(32,47)=(-((-(y(27)*(-y(48))))/T819));
  g1(32,48)=(-((-(y(27)*(-y(47))))/T819));
  g1(33,25)=1;
  g1(33,26)=(-y(34));
  g1(33,34)=(-y(26));
  g1(34,24)=1;
  g1(34,27)=(-((-(params(5)*y(29)))/(params(5)*y(27)*params(5)*y(27))+((-(params(5)*y(29)))/(params(5)*y(27)*params(5)*y(27))*2*y(29)/(params(5)*y(27))+y(48)*(-(params(5)*2*y(47)))/(params(5)*y(27)*params(5)*y(27))+(-(params(5)*2*y(28)))/(params(5)*y(27)*params(5)*y(27)))/(T291+T291)));
  g1(34,28)=(-(2/(params(5)*y(27))/(T291+T291)));
  g1(34,29)=(-(1/(params(5)*y(27))+2*y(29)/(params(5)*y(27))*1/(params(5)*y(27))/(T291+T291)));
  g1(34,47)=(-(y(48)*2/(params(5)*y(27))/(T291+T291)));
  g1(34,48)=(-(2*y(47)/(params(5)*y(27))/(T291+T291)));
  g1(35,1)=1-T299;
  g1(35,2)=(-1);
  ...
  g1(37,23)=(-(params(3)*(-T245)));
  g1(37,31)=(-(params(3)*(-(y(14)*y(8)))));
  g1(37,41)=(-(params(3)*(-(y(6)/y(3)))));
  g1(38,4)=(-(y(26)*(1+T263)));
  g1(38,15)=y(21)*(1+T263);
  g1(38,21)=y(15)*(1+T263);
  ...
  g1(39,8)=(-y(14));
  g1(39,14)=(-y(8));
  g1(39,15)=y(21)*(1+T263);
  g1(39,21)=y(15)*(1+T263);
  g1(39,23)=(-1);
  ...
  g1(44,3)=(-((1-params(19))*params(20)*T539));
  g1(44,13)=T655-params(19)*T655;
