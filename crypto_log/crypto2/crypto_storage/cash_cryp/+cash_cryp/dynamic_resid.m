...
residual(24) = lhs - rhs;
lhs = 1;
rhs = y(55)*(y(80)+params(12)*y(82))/T(18);
residual(25) = lhs - rhs;
lhs = 1;
rhs = y(55)*y(19)/y(79);
residual(26) = lhs - rhs;
lhs = y(21);
rhs = 1+y(43)+T(24)*params(15)*y(26)/(steady_state(12));
residual(27) = lhs - rhs;
lhs = y(38);
rhs = T(2)*T(20);
residual(28) = lhs - rhs;
lhs = y(60);
rhs = T(2)*(T(19)-y(54)/y(79));
residual(29) = lhs - rhs;
lhs = y(39);
rhs = T(2)*(T(19)-y(41)*y(81)/y(20));
residual(30) = lhs - rhs;
lhs = y(37);
rhs = T(2)*y(19)/y(79);
residual(31) = lhs - rhs;
...
residual(33) = lhs - rhs;
lhs = y(34);
rhs = y(39)/(params(5)*y(37))-1/params(1)+T(21);
residual(34) = lhs - rhs;
lhs = y(22);
rhs = y(46)+y(45)+y(28)+y(25)+y(26)*(1+y(43))+T(23);
residual(35) = lhs - rhs;
lhs = y(33);
...
residual(47) = lhs - rhs;
lhs = y(47);
rhs = y(22)-y(20)*y(23)-T(23)-y(45)-y(46);
residual(48) = lhs - rhs;
lhs = y(63);
rhs = log(y(22));
residual(49) = lhs - rhs;
