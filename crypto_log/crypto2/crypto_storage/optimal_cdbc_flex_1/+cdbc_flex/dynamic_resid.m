...
residual(15) = lhs - rhs;
lhs = log(y(50));
rhs = 0.07999999999999996*log(y(11))+0.92*(params(39)*log(y(17))+params(40)*log(y(23)/(steady_state(8))));
residual(16) = lhs - rhs;
lhs = y(55);
rhs = y(49)/y(10);
residual(17) = lhs - rhs;
...
rhs = y(54)/(y(54)+y(53));
residual(20) = lhs - rhs;
lhs = y(57)*params(41)*T(19)*T(20)-params(43)*2*y(54)*(params(42)-y(58))/T(21);
rhs = y(59)-y(50)*params(6)*y(87)/y(81);
residual(21) = lhs - rhs;
lhs = y(57)*params(38)*T(19)*T(22)-params(43)*2*(params(42)-y(58))*T(23);
