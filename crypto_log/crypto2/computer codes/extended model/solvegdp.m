function gdp = solvegdp(BETA,DELTA,ALPHA,THETAE,THETA,RCTARGET,SIGMA,DSBS,VK,GAMMAC,GAMMAS,KAPPAB,CHI,FRISCH )
...
%(1 - (GAMMAC* normcdf(vc-sigma,0,1)*atilde*(1+bc_nc)*nc_ne + GAMMAS* normcdf(vs-sigma,0,1)*atilde*(1+bs_ns)*ns_ne)*1/(1 + b_ne)*(1/atilde)) - inv_y;
