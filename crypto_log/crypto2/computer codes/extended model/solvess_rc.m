function [lambda, c, h, inv, y, k, ne, atilde,b , nc, Hc, bc, Fc, vc, H1c, Gc, omegacbar, rc, G1c,  ns, Hs, bs, Fs, vs, H1s, Gs, omegasbar, rs, G1s, dc, kb, rcl,rsl, w, rp,  q,  rk, a, vk, gdp, sigma, utility, totutility, fshock, ai,omegacbar1, vc1, Fc1,rstilde ] = solvess_rc(BETA,DELTA,ALPHA,THETAE,THETA,RCTARGET,SIGMA,DSBS,VK,GAMMAC,GAMMAS,KAPPAB,CHI,FRISCH )
