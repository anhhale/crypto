function TRANSBC = solvetransbc(BETA,DELTA,ALPHA,THETAE,THETA,RCTARGET,SIGMA,THETAC,VK,GAMMAC,GAMMAS,KAPPAB,CHI,FRISCH )
...
TRANSBC = (nc - THETAE*(Hc*(nc+bc))*atilde)/(THETA*ALPHA*(nc + bc));
