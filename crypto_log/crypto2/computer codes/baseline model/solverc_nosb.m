function F = solverc_nosb(rc,BETA,DELTA,ALPHA,THETAE,THETA,PSID,SIGMA,THETAC,VK,GAMMAC,KAPPAB)

%rc = PIBAR*MUZ/BETA - 0.25/100/4;% only for test to be dropped
rp = 1/BETA;
