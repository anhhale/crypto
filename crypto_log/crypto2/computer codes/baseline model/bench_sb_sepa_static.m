function [residual, g1, g2] = bench_sb_sepa_static(y, x, params)
%
...
T152 = params(16)*(y(12)/y(31)-y(39))^2;
T175 = 1-normcdf(y(14),0,1);
T205 = y(18)-y(8)*y(16)+params(16)*(2*y(12)/y(31)-y(39));
T220 = 1-normcdf(y(24),0,1);
T478 = (-(exp((-(y(14)*y(14)))/2)/2.506628274631));
T483 = exp((-((y(14)-y(41))*(y(14)-y(41))))/2)/2.506628274631;
T484 = (-T483);
T557 = (-(exp((-(y(24)*y(24)))/2)/2.506628274631));
T562 = exp((-((y(24)-y(41))*(y(24)-y(41))))/2)/2.506628274631;
T563 = (-T562);
T646 = 1/params(13)/(y(39)/params(13));
lhs =y(1);
...
residual(15)= lhs-rhs;
lhs =y(10);
rhs =y(8)*params(7)*y(11)*(y(12)+y(10))/y(44)+(y(12)+y(10))*params(3)*params(8)*params(31);
residual(16)= lhs-rhs;
lhs =y(20);
rhs =y(8)*params(7)*y(21)*(y(22)+y(20))/y(44)+(y(22)+y(20))*params(3)*params(8)*params(32);
residual(17)= lhs-rhs;
lhs =y(32);
...
residual(19)= lhs-rhs;
lhs =y(31);
rhs =params(11)*(y(12)*y(32)-y(18)*y(30)-y(31)*T152)+y(12)*params(12);
residual(20)= lhs-rhs;
lhs =y(14);
...
residual(22)= lhs-rhs;
lhs =y(11);
rhs =1-normcdf(y(14)-y(41),0,1)-y(17)*T175;
residual(23)= lhs-rhs;
lhs =y(16);
rhs =y(17)*T175+normcdf(y(14)-y(41),0,1)*(1-params(14));
residual(24)= lhs-rhs;
lhs =y(15);
rhs =(-T175);
residual(25)= lhs-rhs;
lhs =y(19);
rhs =T175-params(14)*normpdf(y(14),0,1)/y(41);
residual(26)= lhs-rhs;
...
residual(30)= lhs-rhs;
lhs =y(21);
rhs =1-normcdf(y(24)-y(41),0,1)-y(27)*T220;
residual(31)= lhs-rhs;
lhs =y(26);
rhs =y(27)*T220+normcdf(y(24)-y(41),0,1)*(1-params(15));
residual(32)= lhs-rhs;
lhs =y(25);
rhs =(-T220);
residual(33)= lhs-rhs;
lhs =y(29);
rhs =T220-params(15)*normpdf(y(24),0,1)/y(41);
residual(34)= lhs-rhs;
...
residual(44)= lhs-rhs;
lhs =y(42);
rhs =log(y(2))+params(9)*log(y(30))-params(4)*y(3)^(1+params(5))/(1+params(5));
residual(45)= lhs-rhs;
lhs =y(46);
rhs =y(22)/(y(12)+y(22));
residual(46)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(15,10)=(-1);
  g1(15,20)=(-1);
  g1(16,8)=(-(params(7)*y(11)*(y(12)+y(10))/y(44)));
  g1(16,10)=1-(params(3)*params(8)*params(31)+y(8)*params(7)*y(11)/y(44));
  g1(16,11)=(-(y(8)*params(7)*(y(12)+y(10))/y(44)));
  g1(16,12)=(-(params(3)*params(8)*params(31)+y(8)*params(7)*y(11)/y(44)));
  g1(16,44)=(-((-(y(8)*params(7)*y(11)*(y(12)+y(10))))/(y(44)*y(44))));
  g1(17,8)=(-(params(7)*y(21)*(y(22)+y(20))/y(44)));
  g1(17,20)=1-(params(3)*params(8)*params(32)+y(8)*params(7)*y(21)/y(44));
  g1(17,21)=(-(y(8)*params(7)*(y(22)+y(20))/y(44)));
  g1(17,22)=(-(params(3)*params(8)*params(32)+y(8)*params(7)*y(21)/y(44)));
  g1(17,44)=(-((-(y(8)*params(7)*y(21)*(y(22)+y(20))))/(y(44)*y(44))));
  ...
  g1(19,30)=1;
  g1(19,31)=1;
  g1(20,12)=(-(params(12)+params(11)*(y(32)-y(31)*params(16)*1/y(31)*2*(y(12)/y(31)-y(39)))));
  g1(20,18)=(-(params(11)*(-y(30))));
  g1(20,30)=(-(params(11)*(-y(18))));
  g1(20,31)=1-params(11)*(-(T152+y(31)*params(16)*2*(y(12)/y(31)-y(39))*(-y(12))/(y(31)*y(31))));
  ...
  g1(22,14)=T478;
  g1(23,11)=1;
  g1(23,14)=(-(T484-y(17)*T478));
  g1(23,17)=T175;
  g1(23,41)=T484;
  g1(24,14)=(-(y(17)*T478+(1-params(14))*T483));
  g1(24,16)=1;
  g1(24,17)=(-T175);
  g1(24,41)=(-((1-params(14))*T484));
  g1(25,14)=T478;
  g1(25,15)=1;
  g1(26,14)=(-(T478-params(14)*normpdf(y(14),0,1)*(-y(14))/y(41)));
  g1(26,19)=1;
  g1(26,41)=(-(params(14)*normpdf(y(14),0,1)))/(y(41)*y(41));
  g1(27,8)=(y(12)+y(10))*y(16);
  g1(27,10)=y(8)*y(16);
  g1(27,12)=y(8)*y(16)-y(32);
  g1(27,16)=y(8)*(y(12)+y(10));
  g1(27,32)=(-y(12));
  g1(28,8)=(-((y(11)*T205-y(8)*y(11)*(-y(16)))/(T205*T205)));
  g1(28,11)=(-(y(8)/T205));
  g1(28,12)=(-((-(y(8)*y(11)*params(16)*2/y(31)))/(T205*T205)));
  g1(28,15)=(-1)/y(19);
  g1(28,16)=(-((-(y(8)*y(11)*(-y(8))))/(T205*T205)));
  g1(28,18)=(-((-(y(8)*y(11)))/(T205*T205)));
  g1(28,19)=y(15)/(y(19)*y(19));
  g1(28,31)=(-((-(y(8)*y(11)*params(16)*(-(2*y(12)))/(y(31)*y(31))))/(T205*T205)));
  g1(28,39)=(-((-(y(8)*y(11)*(-params(16))))/(T205*T205)));
  g1(29,24)=1;
  ...
  g1(30,24)=T557;
  g1(31,21)=1;
  g1(31,24)=(-(T563-y(27)*T557));
  g1(31,27)=T220;
  g1(31,41)=T563;
  g1(32,24)=(-(y(27)*T557+(1-params(15))*T562));
  g1(32,26)=1;
  g1(32,27)=(-T220);
  g1(32,41)=(-((1-params(15))*T563));
  g1(33,24)=T557;
  g1(33,25)=1;
  g1(34,24)=(-(T557-params(15)*normpdf(y(24),0,1)*(-y(24))/y(41)));
  g1(34,29)=1;
  g1(34,41)=(-(params(15)*normpdf(y(24),0,1)))/(y(41)*y(41));
  g1(35,8)=(y(22)+y(20))*y(26);
  g1(35,20)=y(8)*y(26);
  g1(35,22)=y(8)*y(26)-y(28);
  g1(35,26)=y(8)*(y(22)+y(20));
  g1(35,28)=(-y(22));
