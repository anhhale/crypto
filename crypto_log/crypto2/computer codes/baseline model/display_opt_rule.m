% This file is used to generate numbers presented in table 2 and 3
% volatilies, expected means and welfare gain under alternative policies
...
ss_totutility1=oo_bench.steady_state(57);
...
var_bench_totutility1=oo_bench.var(57,57) ;
...
var_osr_totutility1=oo_osr.var(57,57) ;
...
mean_bench_totutility1=oo_bench.mean(57) ;
...
mean_osr_totutility1=oo_osr.mean(57) ;
...
std_inv=[sqrt(var_bench_inv) sqrt(var_osr_inv)]*100/ss_inv
...
% expected mean
mean_gdp = [mean_bench_gdp mean_osr_gdp]/ss_gdp*100 - 100
mean_k   = [mean_bench_k mean_osr_k]/ss_k*100 - 100
mean_c   = [mean_bench_c mean_osr_c]/ss_c*100 - 100
mean_h   = [mean_bench_h mean_osr_h]/ss_h*100 - 100
mean_dc  = [mean_bench_dc mean_osr_dc]/ss_dc*100 - 100
% welfare gain
