...
w   rp      q  rk rstilde //prices
a vk gdp sigma  utility totutility fshock ai
bsshare levtot levs levc car lnb zs zc lngdp Ftot cbprofit;
...
1 =  BETA* lambda(+1)/lambda*rstilde(+1);
...
cbprofit = rcl*bc - rc*dc - KAPPAB*(bc/(kb(-1)) - vk)^2*kb(-1);
