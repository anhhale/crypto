...
if T_flag
    T = crypto_cdbc_quantity.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(50, 1);
lhs = y(61)+y(59);
rhs = 1/T(1);
...
residual(7) = lhs - rhs;
lhs = y(17)*(y(17)-1);
rhs = 1/params(17)*(1+y(16)*params(13)-params(13))+y(58)*y(70)/y(23)*y(66)*(y(66)-1);
residual(8) = lhs - rhs;
lhs = y(23);
rhs = T(14)*T(15);
residual(9) = lhs - rhs;
...
rhs = y(61)-y(50)*params(6)*y(72)/y(66);
residual(23) = lhs - rhs;
lhs = y(59)*params(38)*T(19)*T(22)-params(41)*2*(params(40)-y(60))*T(23);
rhs = y(61)-params(6)*y(72)*params(37)/y(66);
residual(24) = lhs - rhs;
lhs = params(34)*y(53)^(-params(31));
rhs = y(61)-y(57)*params(6)*y(72)/y(66);
residual(25) = lhs - rhs;
lhs = y(19);
rhs = params(8)*y(25)^params(7);
residual(26) = lhs - rhs;
lhs = 1;
rhs = y(58)*(y(67)+params(12)*y(69))/T(24);
residual(27) = lhs - rhs;
lhs = 1;
rhs = y(58)*y(20)/y(66);
residual(28) = lhs - rhs;
...
residual(30) = lhs - rhs;
lhs = y(63);
rhs = T(2)*(T(25)-y(57)/y(66));
residual(31) = lhs - rhs;
lhs = y(40);
rhs = T(2)*(T(25)-y(42)*y(68)/y(21));
residual(32) = lhs - rhs;
lhs = y(38);
rhs = T(2)*y(20)/y(66);
residual(33) = lhs - rhs;
