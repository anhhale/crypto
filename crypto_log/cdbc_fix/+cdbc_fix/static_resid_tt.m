...
T(22) = (y(39)+y(38))^2;
T(23) = y(39)^(-params(29));
T(24) = y(43)/(y(39)+y(38))-1/(y(39)+y(38));
T(25) = y(7)+params(9)*y(17)/y(13);
T(26) = y(5)/y(2);
T(27) = (y(3)+y(7)*params(12))/y(7)-T(26);
T(28) = sqrt((y(25)/(params(5)*y(23)))^2+(1/params(1))^2+y(47)*2*y(46)/(params(5)*y(23))+2*y(24)/(params(5)*y(23)));
T(29) = params(17)/2*(y(2)-1)^2;
T(30) = y(8)*T(29);
