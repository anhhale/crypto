...
residual(7) = lhs - rhs;
lhs = y(16)*(y(16)-1);
rhs = 1/params(17)*(1+y(15)*params(13)-params(13))+y(55)*y(84)/y(22)*y(80)*(y(80)-1);
residual(8) = lhs - rhs;
lhs = y(22);
rhs = T(14)*T(15);
residual(9) = lhs - rhs;
...
rhs = y(58)-y(49)*params(6)*y(86)/y(80);
residual(21) = lhs - rhs;
lhs = y(56)*params(38)*T(19)*T(22)-params(41)*2*(params(40)-y(57))*T(23);
rhs = y(58)-params(6)*y(86)*params(37)/y(80);
residual(22) = lhs - rhs;
lhs = params(34)*y(51)^(-params(31));
rhs = y(58)-y(54)*params(6)*y(86)/y(80);
residual(23) = lhs - rhs;
lhs = y(18);
rhs = params(8)*y(24)^params(7);
residual(24) = lhs - rhs;
lhs = 1;
rhs = y(55)*(y(81)+params(12)*y(83))/T(24);
residual(25) = lhs - rhs;
lhs = 1;
rhs = y(55)*y(19)/y(80);
residual(26) = lhs - rhs;
...
residual(28) = lhs - rhs;
lhs = y(60);
rhs = T(2)*(T(25)-y(54)/y(80));
residual(29) = lhs - rhs;
lhs = y(39);
rhs = T(2)*(T(25)-y(41)*y(82)/y(20));
residual(30) = lhs - rhs;
lhs = y(37);
rhs = T(2)*y(19)/y(80);
residual(31) = lhs - rhs;
